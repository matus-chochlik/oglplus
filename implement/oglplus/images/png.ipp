...
public:
    PNGLoader(std::istream& input, Image& image, bool y_is_up, bool x_is_right);
};
...
OGLPLUS_NORETURN
OGLPLUS_LIB_FUNC
void PNGReadStruct::_png_handle_error(::png_structp /*sp*/, const char* msg) {
    throw ::std::runtime_error(msg);
}

OGLPLUS_LIB_FUNC
void PNGReadStruct::_png_handle_warning(::png_structp /*sp*/, const char* msg) {
...
OGLPLUS_LIB_FUNC
PNGReadInfoStruct::~PNGReadInfoStruct() {
    ::png_destroy_read_struct(
      &_read, &_info, static_cast<::png_infopp>(nullptr));
}
...
int PNGReadInfoEndStruct::_png_read_user_chunk(
  ::png_structp png, ::png_unknown_chunkp chunk) {
...
PNGReadInfoEndStruct::PNGReadInfoEndStruct(PNGLoader& loader)
  ...
  , _end(::png_create_info_struct(_read)) {
    assert(_end);
    ::png_set_read_fn(
      _read, reinterpret_cast<::png_voidp>(&loader), &_png_read_data);
    ::png_set_read_user_chunk_fn(
      _read, reinterpret_cast<::png_voidp>(&loader), &_png_read_user_chunk);
    ::png_set_keep_unknown_chunks(_read, PNG_HANDLE_CHUNK_NEVER, 0, 0);
}

OGLPLUS_LIB_FUNC
PNGReadInfoEndStruct::~PNGReadInfoEndStruct() {
    ::png_destroy_read_struct(&_read, &_info, &_end);
}
...
OGLPLUS_LIB_FUNC
PNGLoader::PNGLoader(
  std::istream& input, Image& image, bool y_is_up, bool x_is_right)
  : _input(input)
