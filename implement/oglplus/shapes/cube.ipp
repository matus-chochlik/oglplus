...
OGLPLUS_LIB_FUNC
DrawingInstructions Cube::Instructions(Cube::Default) const {
...
OGLPLUS_LIB_FUNC
Cube::IndexArray Cube::Indices(Cube::Edges) const {
    /*
     *   (E)-----(A)
     *   /|      /|
     *  / |     / |
...
OGLPLUS_LIB_FUNC
DrawingInstructions Cube::Instructions(Cube::Edges) const {
