...
void SimpleSubdivSphere::_subdivide(
  GLuint ia, GLuint ib, GLuint ic, GLuint levels) {
...
OGLPLUS_LIB_FUNC
void SimpleSubdivSphere::_init_icosah() {
    static const double init_pos[12 * 3] = {
      0.000,  1.000,  0.000,  0.894,  0.447,  0.000,  0.276,  0.447,  0.851,
      -0.724, 0.447,  0.526,  -0.724, 0.447,  -0.526, 0.276,  0.447,  -0.851,
      0.724,  -0.447, 0.526,  -0.276, -0.447, 0.851,  -0.894, -0.447, 0.000,
      -0.276, -0.447, -0.851, 0.724,  -0.447, -0.526, 0.000,  -1.000, 0.000};

    _positions.insert(_positions.end(), init_pos, init_pos + 12 * 3);
...
OGLPLUS_LIB_FUNC
void SimpleSubdivSphere::_init_tetrah() {
    static const double init_pos[4 * 3] = {0.0,
                                           1.0,
                                           0.0,
    ...
    _positions.insert(_positions.end(), init_pos, init_pos + 4 * 3);
...
OGLPLUS_LIB_FUNC
void SimpleSubdivSphere::_init_octoh() {
...
SimpleSubdivSphere::SimpleSubdivSphere(GLuint subdivs, InitialShape init_shape)
  : _subdivs(subdivs) {
    if(init_shape == InitialShape::Icosahedron)
        ...
        OGLPLUS_ABORT("Invalid initial shape!");
}
