...
BitmapGlyphRenderer::BitmapGlyphRenderer(
  ...
  , _prev_layout_storage(nullptr) {
    ...
    vs.Source(
      StrCRef("#if GL_ARB_explicit_attrib_location\n"
              "#version 150\n"
    ...
    ProgramUniform<GLuint>(_program, "GlyphsPerPage")
      .Set(BitmapGlyphGlyphsPerPage(_parent));
    _layout_width_active = _layout_width.IsActive();
}

OGLPLUS_LIB_FUNC
BitmapGlyphDefaultRenderer::BitmapGlyphDefaultRenderer(
  BitmapGlyphRenderingBase& parent, const FragmentShader& pixel_color_shader)
