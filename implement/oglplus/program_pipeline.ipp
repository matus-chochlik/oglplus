...
OGLPLUS_LIB_FUNC
String ObjectOps<tag::DirectState, tag::ProgramPipeline>::GetInfoLog() const {
...
ObjectOps<tag::DirectState, tag::ProgramPipeline>::Validate() {
    OGLPLUS_GLFUNC(ValidateProgramPipeline)(_obj_name());
    OGLPLUS_VERIFY(ValidateProgramPipeline, ObjectError, Object(*this));
...
ObjectOps<tag::DirectState, tag::ProgramPipeline>::Validate(std::nothrow_t) {
    OGLPLUS_GLFUNC(ValidateProgramPipeline)(_obj_name());
    OGLPLUS_DEFERRED_CHECK(ValidateProgramPipeline, ObjectError, Object(*this));
