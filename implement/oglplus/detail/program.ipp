...
OGLPLUS_LIB_FUNC
std::vector<GLchar>& ProgramInterfaceContext::Buffer() {
...
ActiveAttribInfo::ActiveAttribInfo(
  ProgramInterfaceContext& context, GLuint index)
  : ActiveVariableInfo(context, index, OGLPLUS_GLFUNC(GetActiveAttrib)) {
    OGLPLUS_CHECK(
      GetActiveAttrib, ObjectError, Object(context.Program()).Index(index));
}

OGLPLUS_LIB_FUNC
ActiveUniformInfo::ActiveUniformInfo(
  ProgramInterfaceContext& context, GLuint index)
  : ActiveVariableInfo(context, index, OGLPLUS_GLFUNC(GetActiveUniform)) {
    OGLPLUS_CHECK(
      GetActiveUniform, ObjectError, Object(context.Program()).Index(index));
}
...
ActiveSubroutineInfo::ActiveSubroutineInfo(
  ...
  : _index(index) {
    ...
    OGLPLUS_CHECK(
      ...
      ObjectError,
      Object(context.Program()).EnumParam(context.Stage()).Index(index));
...
OGLPLUS_LIB_FUNC
SLDataType ActiveSubroutineInfo::Type() const {
#ifdef None
...
OGLPLUS_LIB_FUNC
SLDataType ActiveSubroutineUniformInfo::Type() const {
#ifdef None
#pragma push_macro("None")
#undef None
    return SLDataType::None;
...
TransformFeedbackVaryingInfo::TransformFeedbackVaryingInfo(
  ProgramInterfaceContext& context, GLuint index)
  : ActiveVariableInfo(
      context, index, OGLPLUS_GLFUNC(GetTransformFeedbackVarying)) {
    OGLPLUS_CHECK(
      GetTransformFeedbackVarying,
      ObjectError,
      Object(context.Program()).Index(index));
}
  ...
  : _index(0) // TODO := index ?
{
    ...
    (GetGLName(context.Program()), GL_UNIFORM_BLOCK_NAME_LENGTH, &length);
    OGLPLUS_VERIFY(
      GetProgramiv,
      ObjectError,
...
OGLPLUS_LIB_FUNC
SLDataType ActiveUniformBlockInfo::Type() const {
#ifdef None
#pragma push_macro("None")
#undef None
    return SLDataType::None;
