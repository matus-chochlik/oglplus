...
OGLPLUS_LIB_FUNC
const std::string& BlendFileFlattenedStructField::Name() const {
    return _flat_fields->_field_names[_flat_field_index];
}

OGLPLUS_LIB_FUNC
BlendFileStruct BlendFileFlattenedStructField::Parent() const {
    return BlendFileStruct(
      _sdna, _flat_fields->_field_structs[_flat_field_index]);
}

OGLPLUS_LIB_FUNC
BlendFileStructField BlendFileFlattenedStructField::Field() const {
...
OGLPLUS_LIB_FUNC
uint32_t BlendFileFlattenedStructField::Offset() const {
    return _flat_fields->_field_offsets[_flat_field_index];
}

OGLPLUS_LIB_FUNC
BlendFileFlattenedStructFieldRange BlendFileFlattenedStruct::Fields() const {
    ...
    return BlendFileFlattenedStructFieldRange(
      _sdna, _struct_index, flat_fields);
}

OGLPLUS_LIB_FUNC
BlendFileFlattenedStructField BlendFileFlattenedStruct::FieldByName(
  const std::string& name) const {
    ...
    return BlendFileFlattenedStructField(
      _sdna, _struct_index, flat_field_index, flat_fields);
}
