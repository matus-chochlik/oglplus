...
void BlendFileReader::_raw_read(
  char* buffer, std::size_t size, const char* error_message) {
    assert(size != 0);
...
void BlendFileReader::_read(
  char* buffer, std::size_t max, const char* error_message) {
    assert(max != 0);
...
OGLPLUS_LIB_FUNC
void BlendFileReader::_skip(std::size_t size, const char* error_message) {
...
void BlendFileReader::_align(
  const std::size_t size, const char* error_message) {
