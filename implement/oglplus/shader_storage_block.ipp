...
OGLPLUS_LIB_FUNC
const char* ProgVarLocOps<tag::ShaderStorageBlock>::MsgGettingInactive() {
    return "Getting the location of inactive program shader-storage block";
}

OGLPLUS_LIB_FUNC
const char* ProgVarLocOps<tag::ShaderStorageBlock>::MsgUsingInactive() {
    return "Using inactive program shader-storage block";
}

OGLPLUS_LIB_FUNC
GLenum ProgVarCommonOps<tag::ShaderStorageBlock>::_translate_ref(
...
OGLPLUS_LIB_FUNC
GLenum ProgVarCommonOps<tag::ShaderStorageBlock>::_translate_max(
  ShaderType shader_type) {
    switch(shader_type) {
#ifdef GL_VERTEX_SHADER
        case ShaderType::Vertex:
