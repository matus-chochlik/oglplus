//  File implement/oglplus/enums/graphics_reset_status_def.ipp
//
...
#  undef GuiltyContextReset
   OGLPLUS_ENUM_CLASS_VALUE(GuiltyContextReset, GL_GUILTY_CONTEXT_RESET)
...
#  undef InnocentContextReset
   OGLPLUS_ENUM_CLASS_VALUE(InnocentContextReset, GL_INNOCENT_CONTEXT_RESET)
...
#  undef UnknownContextReset
   OGLPLUS_ENUM_CLASS_VALUE(UnknownContextReset, GL_UNKNOWN_CONTEXT_RESET)
