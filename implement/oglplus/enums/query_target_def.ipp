//  File implement/oglplus/enums/query_target_def.ipp
//
...
#  undef TimeElapsed
   OGLPLUS_ENUM_CLASS_VALUE(TimeElapsed, GL_TIME_ELAPSED)
...
#  undef Timestamp
   OGLPLUS_ENUM_CLASS_VALUE(Timestamp, GL_TIMESTAMP)
...
#  undef SamplesPassed
   OGLPLUS_ENUM_CLASS_VALUE(SamplesPassed, GL_SAMPLES_PASSED)
...
#  undef AnySamplesPassed
   OGLPLUS_ENUM_CLASS_VALUE(AnySamplesPassed, GL_ANY_SAMPLES_PASSED)
...
#  undef PrimitivesGenerated
   OGLPLUS_ENUM_CLASS_VALUE(PrimitivesGenerated, GL_PRIMITIVES_GENERATED)
...
#  undef TransformFeedbackPrimitivesWritten
   OGLPLUS_ENUM_CLASS_VALUE(TransformFeedbackPrimitivesWritten, GL_TRANSFORM_FEEDBACK_PRIMITIVES_WRITTEN)
...
#  undef VerticesSubmitted
   OGLPLUS_ENUM_CLASS_VALUE(VerticesSubmitted, GL_VERTICES_SUBMITTED_ARB)
...
#  undef PrimitivesSubmitted
   OGLPLUS_ENUM_CLASS_VALUE(PrimitivesSubmitted, GL_PRIMITIVES_SUBMITTED_ARB)
...
#  undef VertexShaderInvocations
   OGLPLUS_ENUM_CLASS_VALUE(VertexShaderInvocations, GL_VERTEX_SHADER_INVOCATIONS_ARB)
...
#  undef TessControlShaderPatches
   OGLPLUS_ENUM_CLASS_VALUE(TessControlShaderPatches, GL_TESS_CONTROL_SHADER_PATCHES_ARB)
...
#  undef TessEvaluationShaderInvocations
   OGLPLUS_ENUM_CLASS_VALUE(TessEvaluationShaderInvocations, GL_TESS_EVALUATION_SHADER_INVOCATIONS_ARB)
...
#  undef GeometryShaderInvocations
   OGLPLUS_ENUM_CLASS_VALUE(GeometryShaderInvocations, GL_GEOMETRY_SHADER_INVOCATIONS)
...
#  undef GeometryShaderPrimitivesEmitted
   OGLPLUS_ENUM_CLASS_VALUE(GeometryShaderPrimitivesEmitted, GL_GEOMETRY_SHADER_PRIMITIVES_EMITTED_ARB)
...
#  undef FragmentShaderInvocations
   OGLPLUS_ENUM_CLASS_VALUE(FragmentShaderInvocations, GL_FRAGMENT_SHADER_INVOCATIONS_ARB)
...
#  undef ComputeShaderInvocations
   OGLPLUS_ENUM_CLASS_VALUE(ComputeShaderInvocations, GL_COMPUTE_SHADER_INVOCATIONS_ARB)
...
#  undef ClippingInputPrimitives
   OGLPLUS_ENUM_CLASS_VALUE(ClippingInputPrimitives, GL_CLIPPING_INPUT_PRIMITIVES_ARB)
...
#  undef ClippingOutputPrimitives
   OGLPLUS_ENUM_CLASS_VALUE(ClippingOutputPrimitives, GL_CLIPPING_OUTPUT_PRIMITIVES_ARB)
