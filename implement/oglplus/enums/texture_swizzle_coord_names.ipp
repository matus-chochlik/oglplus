...
switch(value)
{
	...
	case GL_TEXTURE_SWIZZLE_R: return CStrRef("TEXTURE_SWIZZLE_R");
#endif
#if defined GL_TEXTURE_SWIZZLE_G
	case GL_TEXTURE_SWIZZLE_G: return CStrRef("TEXTURE_SWIZZLE_G");
#endif
#if defined GL_TEXTURE_SWIZZLE_B
	case GL_TEXTURE_SWIZZLE_B: return CStrRef("TEXTURE_SWIZZLE_B");
#endif
#if defined GL_TEXTURE_SWIZZLE_A
	case GL_TEXTURE_SWIZZLE_A: return CStrRef("TEXTURE_SWIZZLE_A");
#endif
#if defined GL_TEXTURE_SWIZZLE_RGBA
	case GL_TEXTURE_SWIZZLE_RGBA: return CStrRef("TEXTURE_SWIZZLE_RGBA");
#endif
	default:;
}
