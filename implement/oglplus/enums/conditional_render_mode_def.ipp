//  File implement/oglplus/enums/conditional_render_mode_def.ipp
//
...
#  undef QueryWait
   OGLPLUS_ENUM_CLASS_VALUE(QueryWait, GL_QUERY_WAIT)
...
#  undef QueryNoWait
   OGLPLUS_ENUM_CLASS_VALUE(QueryNoWait, GL_QUERY_NO_WAIT)
...
#  undef QueryByRegionWait
   OGLPLUS_ENUM_CLASS_VALUE(QueryByRegionWait, GL_QUERY_BY_REGION_WAIT)
...
#  undef QueryByRegionNoWait
   OGLPLUS_ENUM_CLASS_VALUE(QueryByRegionNoWait, GL_QUERY_BY_REGION_NO_WAIT)
...
#  undef QueryWaitInverted
   OGLPLUS_ENUM_CLASS_VALUE(QueryWaitInverted, GL_QUERY_WAIT_INVERTED)
...
#  undef QueryNoWaitInverted
   OGLPLUS_ENUM_CLASS_VALUE(QueryNoWaitInverted, GL_QUERY_NO_WAIT_INVERTED)
...
#  undef QueryByRegionWaitInverted
   OGLPLUS_ENUM_CLASS_VALUE(QueryByRegionWaitInverted, GL_QUERY_BY_REGION_WAIT_INVERTED)
...
#  undef QueryByRegionNoWaitInverted
   OGLPLUS_ENUM_CLASS_VALUE(QueryByRegionNoWaitInverted, GL_QUERY_BY_REGION_NO_WAIT_INVERTED)
