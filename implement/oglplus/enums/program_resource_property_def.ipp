//  File implement/oglplus/enums/program_resource_property_def.ipp
//
...
#  undef ArraySize
   OGLPLUS_ENUM_CLASS_VALUE(ArraySize, GL_ARRAY_SIZE)
...
#  undef Offset
   OGLPLUS_ENUM_CLASS_VALUE(Offset, GL_OFFSET)
...
#  undef BlockIndex
   OGLPLUS_ENUM_CLASS_VALUE(BlockIndex, GL_BLOCK_INDEX)
...
#  undef ArrayStride
   OGLPLUS_ENUM_CLASS_VALUE(ArrayStride, GL_ARRAY_STRIDE)
...
#  undef MatrixStride
   OGLPLUS_ENUM_CLASS_VALUE(MatrixStride, GL_MATRIX_STRIDE)
...
#  undef IsRowMajor
   OGLPLUS_ENUM_CLASS_VALUE(IsRowMajor, GL_IS_ROW_MAJOR)
...
#  undef AtomicCounterBufferIndex
   OGLPLUS_ENUM_CLASS_VALUE(AtomicCounterBufferIndex, GL_ATOMIC_COUNTER_BUFFER_INDEX)
...
#  undef BufferBinding
   OGLPLUS_ENUM_CLASS_VALUE(BufferBinding, GL_BUFFER_BINDING)
...
#  undef BufferDataSize
   OGLPLUS_ENUM_CLASS_VALUE(BufferDataSize, GL_BUFFER_DATA_SIZE)
...
#  undef NumActiveVariables
   OGLPLUS_ENUM_CLASS_VALUE(NumActiveVariables, GL_NUM_ACTIVE_VARIABLES)
...
#  undef ActiveVariables
   OGLPLUS_ENUM_CLASS_VALUE(ActiveVariables, GL_ACTIVE_VARIABLES)
...
#  undef ReferencedByVertexShader
   OGLPLUS_ENUM_CLASS_VALUE(ReferencedByVertexShader, GL_REFERENCED_BY_VERTEX_SHADER)
...
#  undef ReferencedByTessControlShader
   OGLPLUS_ENUM_CLASS_VALUE(ReferencedByTessControlShader, GL_REFERENCED_BY_TESS_CONTROL_SHADER)
...
#  undef ReferencedByGeometryShader
   OGLPLUS_ENUM_CLASS_VALUE(ReferencedByGeometryShader, GL_REFERENCED_BY_GEOMETRY_SHADER)
...
#  undef ReferencedByFragmentShader
   OGLPLUS_ENUM_CLASS_VALUE(ReferencedByFragmentShader, GL_REFERENCED_BY_FRAGMENT_SHADER)
...
#  undef ReferencedByComputeShader
   OGLPLUS_ENUM_CLASS_VALUE(ReferencedByComputeShader, GL_REFERENCED_BY_COMPUTE_SHADER)
...
#  undef NumCompatibleSubroutines
   OGLPLUS_ENUM_CLASS_VALUE(NumCompatibleSubroutines, GL_NUM_COMPATIBLE_SUBROUTINES)
...
#  undef CompatibleSubroutines
   OGLPLUS_ENUM_CLASS_VALUE(CompatibleSubroutines, GL_COMPATIBLE_SUBROUTINES)
...
#  undef TopLevelArraySize
   OGLPLUS_ENUM_CLASS_VALUE(TopLevelArraySize, GL_TOP_LEVEL_ARRAY_SIZE)
...
#  undef Location
   OGLPLUS_ENUM_CLASS_VALUE(Location, GL_LOCATION)
...
#  undef LocationIndex
   OGLPLUS_ENUM_CLASS_VALUE(LocationIndex, GL_LOCATION_INDEX)
