...
switch(value)
{
	...
	case GL_DEBUG_SEVERITY_HIGH_ARB: return CStrRef("DEBUG_SEVERITY_HIGH_ARB");
#endif
#if defined GL_DEBUG_SEVERITY_MEDIUM_ARB
	case GL_DEBUG_SEVERITY_MEDIUM_ARB: return CStrRef("DEBUG_SEVERITY_MEDIUM_ARB");
#endif
#if defined GL_DEBUG_SEVERITY_LOW_ARB
	case GL_DEBUG_SEVERITY_LOW_ARB: return CStrRef("DEBUG_SEVERITY_LOW_ARB");
#endif
