...
switch(value)
{
	...
	case GL_DEBUG_SOURCE_API_ARB: return CStrRef("DEBUG_SOURCE_API_ARB");
#endif
#if defined GL_DEBUG_SOURCE_WINDOW_SYSTEM_ARB
	case GL_DEBUG_SOURCE_WINDOW_SYSTEM_ARB: return CStrRef("DEBUG_SOURCE_WINDOW_SYSTEM_ARB");
#endif
#if defined GL_DEBUG_SOURCE_SHADER_COMPILER_ARB
	case GL_DEBUG_SOURCE_SHADER_COMPILER_ARB: return CStrRef("DEBUG_SOURCE_SHADER_COMPILER_ARB");
#endif
#if defined GL_DEBUG_SOURCE_THIRD_PARTY_ARB
	case GL_DEBUG_SOURCE_THIRD_PARTY_ARB: return CStrRef("DEBUG_SOURCE_THIRD_PARTY_ARB");
#endif
#if defined GL_DEBUG_SOURCE_APPLICATION_ARB
	case GL_DEBUG_SOURCE_APPLICATION_ARB: return CStrRef("DEBUG_SOURCE_APPLICATION_ARB");
#endif
#if defined GL_DEBUG_SOURCE_OTHER_ARB
	case GL_DEBUG_SOURCE_OTHER_ARB: return CStrRef("DEBUG_SOURCE_OTHER_ARB");
#endif
