...
switch(value)
{
	...
	case GL_GUILTY_CONTEXT_RESET_ARB: return CStrRef("GUILTY_CONTEXT_RESET_ARB");
#endif
#if defined GL_INNOCENT_CONTEXT_RESET_ARB
	case GL_INNOCENT_CONTEXT_RESET_ARB: return CStrRef("INNOCENT_CONTEXT_RESET_ARB");
#endif
#if defined GL_UNKNOWN_CONTEXT_RESET_ARB
	case GL_UNKNOWN_CONTEXT_RESET_ARB: return CStrRef("UNKNOWN_CONTEXT_RESET_ARB");
#endif
	default:;
}
