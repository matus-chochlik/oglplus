...
switch(value)
{
	...
	case GL_CLIENT_VERTEX_ARRAY_BIT: return StrLit("CLIENT_VERTEX_ARRAY_BIT");
#endif
#if defined GL_CLIENT_PIXEL_STORE_BIT
	case GL_CLIENT_PIXEL_STORE_BIT: return StrLit("CLIENT_PIXEL_STORE_BIT");
#endif
#if defined GL_CLIENT_ALL_ATTRIB_BITS
	case GL_CLIENT_ALL_ATTRIB_BITS: return StrLit("CLIENT_ALL_ATTRIB_BITS");
#endif
	default:;
}
