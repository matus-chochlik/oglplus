//  File implement/oglplus/enums/clip_depth_mode_def.ipp
//
...
#  undef NegativeOneToOne
   OGLPLUS_ENUM_CLASS_VALUE(NegativeOneToOne, GL_NEGATIVE_ONE_TO_ONE)
...
#  undef ZeroToOne
   OGLPLUS_ENUM_CLASS_VALUE(ZeroToOne, GL_ZERO_TO_ONE)
