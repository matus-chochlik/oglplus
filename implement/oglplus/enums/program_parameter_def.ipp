//  File implement/oglplus/enums/program_parameter_def.ipp
//
...
#  undef DeleteStatus
   OGLPLUS_ENUM_CLASS_VALUE(DeleteStatus, GL_DELETE_STATUS)
...
#  undef LinkStatus
   OGLPLUS_ENUM_CLASS_VALUE(LinkStatus, GL_LINK_STATUS)
...
#  undef ValidateStatus
   OGLPLUS_ENUM_CLASS_VALUE(ValidateStatus, GL_VALIDATE_STATUS)
...
#  undef InfoLogLength
   OGLPLUS_ENUM_CLASS_VALUE(InfoLogLength, GL_INFO_LOG_LENGTH)
...
#  undef AttachedShaders
   OGLPLUS_ENUM_CLASS_VALUE(AttachedShaders, GL_ATTACHED_SHADERS)
...
#  undef ActiveAtomicCounterBuffers
   OGLPLUS_ENUM_CLASS_VALUE(ActiveAtomicCounterBuffers, GL_ACTIVE_ATOMIC_COUNTER_BUFFERS)
...
#  undef ActiveAttributes
   OGLPLUS_ENUM_CLASS_VALUE(ActiveAttributes, GL_ACTIVE_ATTRIBUTES)
...
#  undef ActiveAttributeMaxLength
   OGLPLUS_ENUM_CLASS_VALUE(ActiveAttributeMaxLength, GL_ACTIVE_ATTRIBUTE_MAX_LENGTH)
...
#  undef ActiveUniforms
   OGLPLUS_ENUM_CLASS_VALUE(ActiveUniforms, GL_ACTIVE_UNIFORMS)
...
#  undef ActiveUniformMaxLength
   OGLPLUS_ENUM_CLASS_VALUE(ActiveUniformMaxLength, GL_ACTIVE_UNIFORM_MAX_LENGTH)
...
#  undef ProgramBinaryLength
   OGLPLUS_ENUM_CLASS_VALUE(ProgramBinaryLength, GL_PROGRAM_BINARY_LENGTH)
...
#  undef ComputeWorkGroupSize
   OGLPLUS_ENUM_CLASS_VALUE(ComputeWorkGroupSize, GL_COMPUTE_WORK_GROUP_SIZE)
...
#  undef TransformFeedbackBufferMode
   OGLPLUS_ENUM_CLASS_VALUE(TransformFeedbackBufferMode, GL_TRANSFORM_FEEDBACK_BUFFER_MODE)
...
#  undef TransformFeedbackVaryings
   OGLPLUS_ENUM_CLASS_VALUE(TransformFeedbackVaryings, GL_TRANSFORM_FEEDBACK_VARYINGS)
...
#  undef TransformFeedbackVaryingMaxLength
   OGLPLUS_ENUM_CLASS_VALUE(TransformFeedbackVaryingMaxLength, GL_TRANSFORM_FEEDBACK_VARYING_MAX_LENGTH)
...
#  undef GeometryVerticesOut
   OGLPLUS_ENUM_CLASS_VALUE(GeometryVerticesOut, GL_GEOMETRY_VERTICES_OUT)
...
#  undef GeometryInputType
   OGLPLUS_ENUM_CLASS_VALUE(GeometryInputType, GL_GEOMETRY_INPUT_TYPE)
...
#  undef GeometryOutputType
   OGLPLUS_ENUM_CLASS_VALUE(GeometryOutputType, GL_GEOMETRY_OUTPUT_TYPE)
