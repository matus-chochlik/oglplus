//  File implement/oalplus/enums/alc_error_code_def.ipp
//
...
#  undef NoError
   OALPLUS_ENUM_CLASS_VALUE(NoError, AL_NO_ERROR)
...
#  undef InvalidDevice
   OALPLUS_ENUM_CLASS_VALUE(InvalidDevice, AL_INVALID_DEVICE)
...
#  undef InvalidContext
   OALPLUS_ENUM_CLASS_VALUE(InvalidContext, AL_INVALID_CONTEXT)
...
#  undef InvalidEnum
   OALPLUS_ENUM_CLASS_VALUE(InvalidEnum, AL_INVALID_ENUM)
...
#  undef InvalidValue
   OALPLUS_ENUM_CLASS_VALUE(InvalidValue, AL_INVALID_VALUE)
