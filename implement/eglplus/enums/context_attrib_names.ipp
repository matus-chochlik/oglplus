...
switch(value)
{
	...
	case EGL_CONTEXT_MAJOR_VERSION: return CStrRef("CONTEXT_MAJOR_VERSION");
#endif
#if defined EGL_CONTEXT_MINOR_VERSION
	case EGL_CONTEXT_MINOR_VERSION: return CStrRef("CONTEXT_MINOR_VERSION");
#endif
#if defined EGL_CONTEXT_FLAGS
	case EGL_CONTEXT_FLAGS: return CStrRef("CONTEXT_FLAGS");
#endif
#if defined EGL_CONTEXT_OPENGL_PROFILE_MASK
	case EGL_CONTEXT_OPENGL_PROFILE_MASK: return CStrRef("CONTEXT_OPENGL_PROFILE_MASK");
#endif
#if defined EGL_CONTEXT_OPENGL_RESET_NOTIFICATION_STRATEGY
	case EGL_CONTEXT_OPENGL_RESET_NOTIFICATION_STRATEGY: return CStrRef("CONTEXT_OPENGL_RESET_NOTIFICATION_STRATEGY");
#endif
	default:;
}
