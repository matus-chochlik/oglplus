//  File implement/eglplus/enums/surface_attrib_def.ipp
//
...
#  undef Width
   EGLPLUS_ENUM_CLASS_VALUE(Width, EGL_WIDTH)
...
#  undef Height
   EGLPLUS_ENUM_CLASS_VALUE(Height, EGL_HEIGHT)
...
#  undef VGAlphaFormat
   EGLPLUS_ENUM_CLASS_VALUE(VGAlphaFormat, EGL_VG_ALPHA_FORMAT)
...
#  undef HorizontalResolution
   EGLPLUS_ENUM_CLASS_VALUE(HorizontalResolution, EGL_HORIZONTAL_RESOLUTION)
...
#  undef VerticalResolution
   EGLPLUS_ENUM_CLASS_VALUE(VerticalResolution, EGL_VERTICAL_RESOLUTION)
...
#  undef LargestPbuffer
   EGLPLUS_ENUM_CLASS_VALUE(LargestPbuffer, EGL_LARGEST_PBUFFER)
...
#  undef MipmapTexture
   EGLPLUS_ENUM_CLASS_VALUE(MipmapTexture, EGL_MIPMAP_TEXTURE)
...
#  undef MipmapLevel
   EGLPLUS_ENUM_CLASS_VALUE(MipmapLevel, EGL_MIPMAP_LEVEL)
...
#  undef MultisampleResolve
   EGLPLUS_ENUM_CLASS_VALUE(MultisampleResolve, EGL_MULTISAMPLE_RESOLVE)
...
#  undef PixelAspectRatio
   EGLPLUS_ENUM_CLASS_VALUE(PixelAspectRatio, EGL_PIXEL_ASPECT_RATIO)
...
#  undef RenderBuffer
   EGLPLUS_ENUM_CLASS_VALUE(RenderBuffer, EGL_RENDER_BUFFER)
...
#  undef SwapBehavior
   EGLPLUS_ENUM_CLASS_VALUE(SwapBehavior, EGL_SWAP_BEHAVIOR)
...
#  undef TextureFormat
   EGLPLUS_ENUM_CLASS_VALUE(TextureFormat, EGL_TEXTURE_FORMAT)
...
#  undef TextureTarget
   EGLPLUS_ENUM_CLASS_VALUE(TextureTarget, EGL_TEXTURE_TARGET)
