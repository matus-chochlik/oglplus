...
switch(value)
{
	...
	case EGL_MULTISAMPLE_RESOLVE_DEFAULT: return CStrRef("MULTISAMPLE_RESOLVE_DEFAULT");
#endif
#if defined EGL_MULTISAMPLE_RESOLVE_BOX
	case EGL_MULTISAMPLE_RESOLVE_BOX: return CStrRef("MULTISAMPLE_RESOLVE_BOX");
#endif
	default:;
}
