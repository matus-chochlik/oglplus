//  File implement/eglplus/enums/error_code_def.ipp
//
...
#  undef NotInitialized
   EGLPLUS_ENUM_CLASS_VALUE(NotInitialized, EGL_NOT_INITIALIZED)
...
#  undef BadAccess
   EGLPLUS_ENUM_CLASS_VALUE(BadAccess, EGL_BAD_ACCESS)
...
#  undef BadAlloc
   EGLPLUS_ENUM_CLASS_VALUE(BadAlloc, EGL_BAD_ALLOC)
...
#  undef BadAttribute
   EGLPLUS_ENUM_CLASS_VALUE(BadAttribute, EGL_BAD_ATTRIBUTE)
...
#  undef BadContext
   EGLPLUS_ENUM_CLASS_VALUE(BadContext, EGL_BAD_CONTEXT)
...
#  undef BadConfig
   EGLPLUS_ENUM_CLASS_VALUE(BadConfig, EGL_BAD_CONFIG)
...
#  undef BadCurrentSurface
   EGLPLUS_ENUM_CLASS_VALUE(BadCurrentSurface, EGL_BAD_CURRENT_SURFACE)
...
#  undef BadMatch
   EGLPLUS_ENUM_CLASS_VALUE(BadMatch, EGL_BAD_MATCH)
...
#  undef BadParameter
   EGLPLUS_ENUM_CLASS_VALUE(BadParameter, EGL_BAD_PARAMETER)
...
#  undef BadNativePixmap
   EGLPLUS_ENUM_CLASS_VALUE(BadNativePixmap, EGL_BAD_NATIVE_PIXMAP)
...
#  undef BadNativeWindow
   EGLPLUS_ENUM_CLASS_VALUE(BadNativeWindow, EGL_BAD_NATIVE_WINDOW)
...
#  undef ContextLost
   EGLPLUS_ENUM_CLASS_VALUE(ContextLost, EGL_CONTEXT_LOST)
