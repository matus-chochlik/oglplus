...
switch(value)
{
	...
	case EGL_CONTEXT_OPENGL_CORE_PROFILE_BIT_KHR: return StrLit("CONTEXT_OPENGL_CORE_PROFILE_BIT_KHR");
#endif
#if defined EGL_CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT_KHR
	case EGL_CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT_KHR: return StrLit("CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT_KHR");
#endif
	default:;
}
