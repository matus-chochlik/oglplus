...
switch(value)
{
	...
	case EGL_CONTEXT_OPENGL_DEBUG_BIT: return CStrRef("CONTEXT_OPENGL_DEBUG_BIT");
#endif
#if defined EGL_CONTEXT_OPENGL_FORWARD_COMPATIBLE_BIT
	case EGL_CONTEXT_OPENGL_FORWARD_COMPATIBLE_BIT: return CStrRef("CONTEXT_OPENGL_FORWARD_COMPATIBLE_BIT");
#endif
#if defined EGL_CONTEXT_OPENGL_ROBUST_ACCESS_BIT
	case EGL_CONTEXT_OPENGL_ROBUST_ACCESS_BIT: return CStrRef("CONTEXT_OPENGL_ROBUST_ACCESS_BIT");
#endif
	default:;
}
