//  File implement/eglplus/enums/config_attrib_def.ipp
//
...
#  undef BufferSize
   EGLPLUS_ENUM_CLASS_VALUE(BufferSize, EGL_BUFFER_SIZE)
...
#  undef RedSize
   EGLPLUS_ENUM_CLASS_VALUE(RedSize, EGL_RED_SIZE)
...
#  undef GreenSize
   EGLPLUS_ENUM_CLASS_VALUE(GreenSize, EGL_GREEN_SIZE)
...
#  undef BlueSize
   EGLPLUS_ENUM_CLASS_VALUE(BlueSize, EGL_BLUE_SIZE)
...
#  undef LuminanceSize
   EGLPLUS_ENUM_CLASS_VALUE(LuminanceSize, EGL_LUMINANCE_SIZE)
...
#  undef AlphaSize
   EGLPLUS_ENUM_CLASS_VALUE(AlphaSize, EGL_ALPHA_SIZE)
...
#  undef AlphaMaskSize
   EGLPLUS_ENUM_CLASS_VALUE(AlphaMaskSize, EGL_ALPHA_MASK_SIZE)
...
#  undef BindToTextureRGB
   EGLPLUS_ENUM_CLASS_VALUE(BindToTextureRGB, EGL_BIND_TO_TEXTURE_RGB)
...
#  undef BindToTextureRGBA
   EGLPLUS_ENUM_CLASS_VALUE(BindToTextureRGBA, EGL_BIND_TO_TEXTURE_RGBA)
...
#  undef ColorBufferType
   EGLPLUS_ENUM_CLASS_VALUE(ColorBufferType, EGL_COLOR_BUFFER_TYPE)
...
#  undef ConfigCaveat
   EGLPLUS_ENUM_CLASS_VALUE(ConfigCaveat, EGL_CONFIG_CAVEAT)
...
#  undef ConfigId
   EGLPLUS_ENUM_CLASS_VALUE(ConfigId, EGL_CONFIG_ID)
...
#  undef Conformant
   EGLPLUS_ENUM_CLASS_VALUE(Conformant, EGL_CONFORMANT)
...
#  undef DepthSize
   EGLPLUS_ENUM_CLASS_VALUE(DepthSize, EGL_DEPTH_SIZE)
...
#  undef Level
   EGLPLUS_ENUM_CLASS_VALUE(Level, EGL_LEVEL)
...
#  undef MaxSwapInterval
   EGLPLUS_ENUM_CLASS_VALUE(MaxSwapInterval, EGL_MAX_SWAP_INTERVAL)
...
#  undef MinSwapInterval
   EGLPLUS_ENUM_CLASS_VALUE(MinSwapInterval, EGL_MIN_SWAP_INTERVAL)
...
#  undef NativeRenderable
   EGLPLUS_ENUM_CLASS_VALUE(NativeRenderable, EGL_NATIVE_RENDERABLE)
...
#  undef NativeVisualId
   EGLPLUS_ENUM_CLASS_VALUE(NativeVisualId, EGL_NATIVE_VISUAL_ID)
...
#  undef NativeVisualType
   EGLPLUS_ENUM_CLASS_VALUE(NativeVisualType, EGL_NATIVE_VISUAL_TYPE)
...
#  undef RenderableType
   EGLPLUS_ENUM_CLASS_VALUE(RenderableType, EGL_RENDERABLE_TYPE)
...
#  undef SampleBuffers
   EGLPLUS_ENUM_CLASS_VALUE(SampleBuffers, EGL_SAMPLE_BUFFERS)
...
#  undef Samples
   EGLPLUS_ENUM_CLASS_VALUE(Samples, EGL_SAMPLES)
...
#  undef StencilSize
   EGLPLUS_ENUM_CLASS_VALUE(StencilSize, EGL_STENCIL_SIZE)
...
#  undef SurfaceType
   EGLPLUS_ENUM_CLASS_VALUE(SurfaceType, EGL_SURFACE_TYPE)
...
#  undef TransparentType
   EGLPLUS_ENUM_CLASS_VALUE(TransparentType, EGL_TRANSPARENT_TYPE)
...
#  undef TransparentRedValue
   EGLPLUS_ENUM_CLASS_VALUE(TransparentRedValue, EGL_TRANSPARENT_RED_VALUE)
...
#  undef TransparentGreenValue
   EGLPLUS_ENUM_CLASS_VALUE(TransparentGreenValue, EGL_TRANSPARENT_GREEN_VALUE)
...
#  undef TransparentBlueValue
   EGLPLUS_ENUM_CLASS_VALUE(TransparentBlueValue, EGL_TRANSPARENT_BLUE_VALUE)
