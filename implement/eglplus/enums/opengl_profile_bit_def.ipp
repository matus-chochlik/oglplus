...
#  undef Core
   EGLPLUS_ENUM_CLASS_VALUE(Core, EGL_CONTEXT_OPENGL_CORE_PROFILE_BIT_KHR)
...
#  undef Compatibility
   EGLPLUS_ENUM_CLASS_VALUE(Compatibility, EGL_CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT_KHR)
