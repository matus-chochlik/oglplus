...
void oalplus_py_Context(void)
{
	...
	bpy::class_<ContextOps>("ContextOps", bpy::no_init)
		...
		.def("Vendor", &ContextOps::Vendor).staticmethod("Vendor")
		.def("Version", &ContextOps::Version).staticmethod("Version")
		.def("Renderer", &ContextOps::Renderer).staticmethod("Renderer")
		.def("Extensions", &ContextOps::Extensions).staticmethod("Extensions")
