...
void oalplus_py_Source(void)
{
	...
	bpy::class_<SourceOps>("SourceOps", bpy::no_init)
		...
		.def("Position", (void(SourceOps::*)(const Vec3f&))&SourceOps::Position)
		.def("Position", (void(SourceOps::*)(ALfloat,ALfloat,ALfloat))&SourceOps::Position)
		.def("Position", (Vec3f (SourceOps::*)(void) const)&SourceOps::Position)
		.def("Velocity", (void(SourceOps::*)(const Vec3f&))&SourceOps::Velocity)
		.def("Velocity", (void(SourceOps::*)(ALfloat,ALfloat,ALfloat))&SourceOps::Velocity)
		.def("Velocity", (Vec3f(SourceOps::*)(void) const)&SourceOps::Velocity)
		.def("Direction", (void(SourceOps::*)(const Vec3f&))&SourceOps::Direction)
		.def("Direction", (void(SourceOps::*)(ALfloat,ALfloat,ALfloat))&SourceOps::Direction)
		.def("Direction", (Vec3f(SourceOps::*)(void) const)&SourceOps::Direction)
		.def("ConeInnerAngle", (void(SourceOps::*)(Anglef))&SourceOps::ConeInnerAngle)
		.def("ConeInnerAngle", (Anglef(SourceOps::*)(void) const)&SourceOps::ConeInnerAngle)
		.def("ConeOuterAngle", (void(SourceOps::*)(Anglef))&SourceOps::ConeOuterAngle)
		.def("ConeOuterAngle", (Anglef(SourceOps::*)(void) const)&SourceOps::ConeOuterAngle)
		.def("ConeOuterGain", (void(SourceOps::*)(ALfloat))&SourceOps::ConeOuterGain)
		.def("ConeOuterGain", (ALfloat(SourceOps::*)(void) const)&SourceOps::ConeOuterGain)
		.def("SecOffset", (void(SourceOps::*)(ALfloat))&SourceOps::SecOffset)
		.def("SampleOffset", (void(SourceOps::*)(const ALfloat&))&SourceOps::SampleOffset)
		.def("ByteOffset", (void(SourceOps::*)(ALfloat))&SourceOps::ByteOffset)
	;
