...
class SurfaceVertShader : public VertexShader {
public:
    SurfaceVertShader()
      : VertexShader(
...
class SurfaceGeomShader : public GeometryShader {
public:
    SurfaceGeomShader()
      : GeometryShader(
          ...
          "void make_quad(int a1,int a2,int b1,int b2,int c1,int c2,int d1,int "
          "d2)"
          "{"
          "	float ta = find_t(a1, a2);"
          "	float tb = find_t(b1, b2);"
...
class SurfaceFragShader : public FragmentShader {
public:
    SurfaceFragShader()
      : FragmentShader(
