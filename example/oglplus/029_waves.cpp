...
class LiquidVertShader : public VertexShader {
public:
    LiquidVertShader()
      : VertexShader(
...
class LiquidGeomShader : public GeometryShader {
private:
    ...
    LiquidGeomShader()
      : GeometryShader(
          ...
          StrCRef("#version 150\n"
                  ...
                  "{"
                  "	ivec4 i = "
                  "ivec4(vertSign[a],vertSign[b],vertSign[c],vertSign[d]);"
...
class LiquidFragShader : public FragmentShader {
public:
    LiquidFragShader()
      : FragmentShader(
...
class LiquidProgram
  ...
  , public Program {
private:
    const LiquidProgramShaders& shaders() const {
        return *this;
    }
...
public:
    ...
    void Reshape(GLuint width, GLuint height) {
        ...
        perspective =
          CamMatrixf::PerspectiveX(Degrees(65), width, height, 1, 100);
    }
