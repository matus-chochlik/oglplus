...
public:
      ...
      , camera_matrix(prog, "CameraMatrix") {
        ...
        fs.Source(
          StrCRef("#version 120\n"
                  ...
                  "void main()"
                  "{"
                  "	gl_FragColor = vec4(textureCube(EnvMap, "
                  "normalize(vertTexCoord)).rgb, 1.0);"
                  "}"));
        fs.Compile();
        ...
        GLuint sky_box_indices[6 * 5] = {1, 3, 5, 7, 9, 4, 6, 0, 2, 9,
                                         2, 6, 3, 7, 9, 4, 0, 5, 1, 9,
                                         5, 7, 4, 6, 9, 0, 2, 1, 3, 9};
    ...
    void Render(double time) {
        ...
        gl.DrawElements(
          PrimitiveType::TriangleStrip, 6 * 5, DataType::UnsignedInt);
    }
