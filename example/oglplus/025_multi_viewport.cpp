...
private:
	...
	Uniform<Mat4f> camera_matrix_0, camera_matrix_1, camera_matrix_2,
	  camera_matrix_3, model_matrix;
...
public:
	...
	void Reshape(GLuint width, GLuint height) {
		...
		projection =
		  CamMatrixf::PerspectiveX(Degrees(65), float(width) / height, 1, 30);

		camera_matrix_0.Set(projection
							* Mat4f(Vec4f(0, 0, -1, 0),
								Vec4f(0, 1, 0, 0),
								Vec4f(1, 0, 0, -3),
								Vec4f(0, 0, 0, 1)));
		camera_matrix_1.Set(projection
							* Mat4f(Vec4f(1, 0, 0, 0),
								Vec4f(0, 0, -1, 0),
								Vec4f(0, 1, 0, -3),
								Vec4f(0, 0, 0, 1)));
		camera_matrix_2.Set(projection
							* Mat4f(Vec4f(1, 0, 0, 0),
								Vec4f(0, 1, 0, 0),
								Vec4f(0, 0, 1, -3),
								Vec4f(0, 0, 0, 1)));
	...
	void Render(double time) {
		...
		//
		CamMatrixf camera = CamMatrixf::Orbiting(Vec3f(),
		...
		model_matrix.Set(ModelMatrixf::RotationX(FullCircles(time / 10.0)));
