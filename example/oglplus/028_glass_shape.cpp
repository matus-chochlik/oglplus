...
private:
    ...
    Uniform<Mat4f> plane_proj_matrix, plane_camera_matrix, plane_model_matrix,
...
public:
    ...
    void Reshape(GLuint vp_width, GLuint vp_height) {
        ...
        Mat4f projection =
          CamMatrixf::PerspectiveX(Degrees(48), float(width) / height, 1, 15);
        plane_prog.Use();
    ...
    void Render(double time) {
        ...
        plane_model_matrix.Set(ModelMatrixf::Translation(0.0f, -1.1f, 0.0f));
