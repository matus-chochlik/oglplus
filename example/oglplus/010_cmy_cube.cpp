...
public:
    CubeExample() {
        ...
        fs.Source(
            ...
            "void main()"
            "{"
            "	gl_FragColor = vec4(normalize(abs(vec3(1, 1, 1) - "
            "vertNormal)), 1.0);"
            "}")
          .Compile();
        ...
        const GLfloat c[8][3] = {{-0.5f, -0.5f, +0.5f},
                                 {-0.5f, -0.5f, -0.5f},
                                 {-0.5f, +0.5f, -0.5f},
                                 {-0.5f, +0.5f, +0.5f},
                                 {+0.5f, -0.5f, +0.5f},
        ...
        const GLfloat cube_vertices[vertex_count * 3] = {
          ...
          c[1][0], c[1][1], c[1][2], c[0][0], c[0][1], c[0][2],
          c[3][0], c[3][1], c[3][2], c[2][0], c[2][1], c[2][2],

          c[0][0], c[0][1], c[0][2], c[1][0], c[1][1], c[1][2],
          c[4][0], c[4][1], c[4][2], c[1][0], c[1][1], c[1][2],
          c[5][0], c[5][1], c[5][2], c[4][0], c[4][1], c[4][2],

          c[1][0], c[1][1], c[1][2], c[2][0], c[2][1], c[2][2],
          c[5][0], c[5][1], c[5][2], c[2][0], c[2][1], c[2][2],
          c[6][0], c[6][1], c[6][2], c[5][0], c[5][1], c[5][2],

          c[4][0], c[4][1], c[4][2], c[5][0], c[5][1], c[5][2],
          c[6][0], c[6][1], c[6][2], c[4][0], c[4][1], c[4][2],
          c[6][0], c[6][1], c[6][2], c[7][0], c[7][1], c[7][2],

          c[2][0], c[2][1], c[2][2], c[3][0], c[3][1], c[3][2],
          c[7][0], c[7][1], c[7][2], c[2][0], c[2][1], c[2][2],
          c[7][0], c[7][1], c[7][2], c[6][0], c[6][1], c[6][2],

          c[0][0], c[0][1], c[0][2], c[4][0], c[4][1], c[4][2],
          c[3][0], c[3][1], c[3][2], c[3][0], c[3][1], c[3][2],
          c[4][0], c[4][1], c[4][2], c[7][0], c[7][1], c[7][2]};
        ...
        // upload the data
        Buffer::Data(Buffer::Target::Array, vertex_count * 3, cube_normals);
        // setup the vertex attribs array for the vertices
        ...
        Uniform<Mat4f>(prog, "CameraMatrix")
          .Set(CamMatrixf::LookingAt(Vec3f(2.0f, 2.0f, 2.0f), Vec3f()));
        //
    ...
    void Reshape(GLuint width, GLuint height) {
        ...
        Uniform<Mat4f>(prog, "ProjectionMatrix")
          .Set(CamMatrixf::PerspectiveX(
            Degrees(48), GLfloat(width) / height, 1, 100));
    }
