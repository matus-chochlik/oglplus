...
public:
    RectangleExample()
      : scroll_factor(prog, "ScrollFactor") {
        ...
        GLfloat min = 3.0f;
        GLfloat max = 4.0f;
        GLfloat rectangle_coords[8] = {min, min, min, max, max, min, max, max};
        // bind the VBO for the rectangle vertices
        ...
        GLfloat colormap[nclr * 4] = {
          0.4f, 0.2f,  1.0f, 0.00f, 1.0f, 0.2f,  0.2f, 0.30f, 1.0f, 1.0f,
          1.0f, 0.95f, 1.0f, 1.0f,  1.0f, 0.98f, 0.1f, 0.1f,  0.1f, 1.00f};
    ...
    ExampleTimePeriod DefaultTimeout() {
        return ExampleTimePeriod::Seconds(15.0);
    }
};
