        ...
        prog
          ...
          .AttachShader(FragmentShader(
            ...
            StrCRef(
              ...
              "	fragBump = vec4(normalize(fragNormal),clamp(fragHeight, 0.0, "
              "1.0));"
              "}")))
          .Link()
          .Use();
...
public:
    FlowSimulator(const images::Image& flow_map_image, GLuint first_tex_unit)
      : size(1024)
      , prog(size)
        ...
        prog
          ...
          .AttachShader(FragmentShader(
            ...
            StrCRef("#version 140\n"
                    ...
                    "	float l = clamp(nm.w+pow(dot(nm.xy,vec2(0.2,0.2)), "
                    "9.0), 0.3, 1.1);"
