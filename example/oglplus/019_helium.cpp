...
public:
    ...
    void Reshape(GLuint width, GLuint height) {
        ...
        auto projection =
          CamMatrixf::PerspectiveX(Degrees(60), width, height, 1, 50);
    ...
    void Render(double time) {
        ...
        auto nucl =
          ModelMatrixf::RotationA(Vec3f(1.0f, 1.0f, 1.0f), FullCircles(time));
