...
private:
    ...
    Lazy<ProgramUniform<Mat4f>> sky_box_projection_matrix,
      sky_box_camera_matrix, shape_projection_matrix, shape_camera_matrix,
      shape_model_matrix;

    Lazy<ProgramUniform<Vec3f>> sky_box_sun_position, shape_sun_position,
