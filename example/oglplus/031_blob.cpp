...
class BlobVertShader : public VertexShader {
public:
    BlobVertShader()
      : VertexShader(
...
class BlobGeomShader : public GeometryShader {
private:
...
class BlobFragShader : public FragmentShader {
public:
    BlobFragShader()
      : FragmentShader(
...
class MetalVertShader : public VertexShader {
public:
    MetalVertShader()
      : VertexShader(
...
class MetalFragShader : public FragmentShader {
public:
    MetalFragShader()
      : FragmentShader(
...
class Plate : public shapes::ShapeWrapper {
private:
    static const GLchar** AttrNames() {
        static const GLchar* names[] = {
          "Position", "Normal", "Tangent", "TexCoord"};
        return names;
    }
    static GLuint AttrCount() {
        return 4;
    }
