...
private:
    ...
    ProgramUniform<Mat4f> plane_projection_matrix, plane_camera_matrix,
      plane_model_matrix, shape_projection_matrix, shape_camera_matrix,
      shape_model_matrix;
...
public:
    ...
    void Render(double time) {
        ...
        shape_model_matrix = ModelMatrixf::Translation(0.0f, 1.1f, 0.0f) *
