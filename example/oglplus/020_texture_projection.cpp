...
private:
    ...
    Lazy<Uniform<Mat4f>> projection_matrix, tex_projection_matrix, model_matrix;
...
public:
    CubeExample()
      ...
      , model_matrix(prog, "ModelMatrix") {
        ...
        Uniform<Mat4f>(prog, "CameraMatrix")
          .Set(CamMatrixf::LookingAt(Vec3f(0.0f, 1.0f, 2.0f), Vec3f()));
    ...
    void Render(double time) {
        ...
        model_matrix.Set(ModelMatrixf::RotationY(FullCircles(time * 0.1)));
