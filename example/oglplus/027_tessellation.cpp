...
public:
    TessellationExample()
      ...
      , step(10.0f) {
        ...
        vert.Source(StrCRef(
          ...
          "	vertColor = "
          "normalize(normalize(vec3(1,1,1))-normalize(Position.xyz));"
        ...
        teco.Source(StrCRef(
          ...
          "patch out vec3 tecoPosition[4], tecoPrevCP[4], tecoNextCP[4], "
          "tecoColor[4];"
          ...
          "		);"
          "	}"
          "	gl_TessLevelOuter[ID] = "
          "1+int(vertTessLevel[PrevID].x*calc_tl(mid(PrevID, ID)));"
        ...
        teev.Source(
          StrCRef("#version 150\n"
                  ...
                  "patch in vec3 tecoPosition[4], tecoPrevCP[4], "
                  "tecoNextCP[4], tecoColor[4];"
                  ...
                  "	vec4 tempPosition = vec4(dot(Cx * vp, up), dot(Cy * vp, "
                  "up), dot(Cz * vp, up), 1.0);"
        ...
        geom.Source(
          StrCRef("#version 150\n"
                  ...
                  "		float Width = 0.6+dot(PatchDist[(v+1)%3], "
                  "PatchDist[(v+2)%3])*1.4;"
        ...
        GLfloat kpa = GLfloat(
          (4.0f / segments) * (4.0f / 3.0f) * (sqrt(2.0f) - 1.0f) / sqrt(2.0f));
    ...
    void Render(double time) {
        ...
        camera_matrix.Set(CamMatrixf::LookingAt(
          Vec3f(
        ...
        gl.DrawArraysInstanced(
          PrimitiveType::Patches, 0, segments * 4, instances);
    }
