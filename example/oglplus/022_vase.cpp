...
public:
	VaseVertShader(void)
	  : VertexShader(ObjectDesc("Vase vertex"),
		  StrCRef(
			"#version 140\n"
...
public:
	VaseFragShader(void)
	  : FragmentShader(ObjectDesc("Vase fragment"),
		  StrCRef("#version 140\n"
...
public:
	VaseExample(void)
	  : vase(List("Position")("Normal")("TexCoord").Get(),
		  shapes::RevolveY<GLfloat>(36,
			BezierCurves<Vec3f, GLfloat, 3>(
			  ListOf<Vec3f>(Vec3f(0.00f, 0.00f, 0.00f))

				(Vec3f(0.20f, 0.00f, 0.00f))(Vec3f(0.40f, 0.00f, 0.00f))(
				  Vec3f(0.80f, 0.00f, 0.00f))

				  (Vec3f(1.45f, 0.00f, 0.00f))(Vec3f(1.45f, 0.40f, 0.00f))(
					Vec3f(1.40f, 0.80f, 0.00f))

					(Vec3f(1.35f, 1.20f, 0.00f))(Vec3f(1.20f, 1.30f, 0.00f))(
					  Vec3f(1.00f, 1.50f, 0.00f))

					  (Vec3f(0.80f, 1.70f, 0.00f))(Vec3f(0.80f, 2.20f, 0.00f))(
						Vec3f(0.90f, 2.50f, 0.00f))

						(Vec3f(1.00f, 2.80f, 0.00f))(Vec3f(
						  0.98f, 2.88f, 0.00f))(Vec3f(1.05f, 2.90f, 0.00f))

						  (Vec3f(1.12f, 2.92f, 0.00f))(Vec3f(
							1.09f, 2.96f, 0.00f))(Vec3f(1.05f, 2.99f, 0.00f))

							(Vec3f(1.01f, 3.02f, 0.00f))(Vec3f(
							  0.96f, 2.99f, 0.00f))(Vec3f(0.93f, 2.90f, 0.00f))
			...
			std::vector<Vec3f>(),
			BezierCurves<Vec3f, GLfloat, 3>(
			  ListOf<Vec3f>(Vec3f(5.00f, -2.00f, 1.00f))

				(Vec3f(5.00f, -1.67f, 1.00f))(Vec3f(5.00f, -1.33f, 1.00f))(
				  Vec3f(5.00f, -1.00f, 1.00f))

				  (Vec3f(5.00f, -0.67f, 1.00f))(Vec3f(5.00f, -0.33f, 1.00f))(
					Vec3f(5.00f, 0.00f, 1.00f))

					(Vec3f(5.00f, 0.20f, 1.00f))(Vec3f(5.00f, 0.40f, 1.00f))(
					  Vec3f(5.00f, 0.60f, 1.00f))

					  (Vec3f(5.00f, 0.80f, 1.00f))(Vec3f(5.00f, 1.00f, 1.00f))(
						Vec3f(5.00f, 1.15f, 1.00f))

						(Vec3f(5.00f, 1.30f, 1.00f))(Vec3f(
						  5.00f, 1.45f, 0.40f))(Vec3f(5.00f, 1.60f, 0.60f))

						  (Vec3f(5.00f, 1.75f, 1.00f))(Vec3f(
							5.00f, 1.90f, 1.00f))(Vec3f(5.00f, 2.10f, 1.00f))

							(Vec3f(5.00f, 2.20f, 1.00f))(Vec3f(
							  5.00f, 2.35f, 1.00f))(Vec3f(5.00f, 2.50f, 1.00f))
		...
		{
			GLuint tex_side = 512;
			auto image = images::NewtonFractal(tex_side,
			  tex_side,
	...
	void Reshape(GLuint width, GLuint height) {
		...
		vase_prog.projection_matrix =
		  CamMatrixf::PerspectiveX(Degrees(60), width, height, 1, 30);
	}

	void Render(double time) {
		gl.Clear().ColorBuffer().DepthBuffer();
		//
		auto camera = CamMatrixf::Orbiting(Vec3f(0.0, 1.5, 0.0),
