...
public:
      ...
      , height(tex_side) {
        ...
        for(GLuint i = 0; i != 2; ++i) {
            ...
            gl.Bound(Framebuffer::Target::Draw, fbos[i])
              .AttachTexture(FramebufferAttachment::Color, texs[i], 0)
              .AttachRenderbuffer(FramebufferAttachment::Depth, rbos[i]);
        }
    ...
    void Render(double time) {
        ...
        projection_matrix.Set(
          CamMatrixf::PerspectiveX(Degrees(75), float(width) / height, 1, 40));
