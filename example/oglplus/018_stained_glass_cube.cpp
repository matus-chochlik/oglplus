...
public:
    CubeExample()
      ...
      , model_matrix(prog, "ModelMatrix") {
        ...
        // setup the texture
        tex << Texture::Target::_2D << images::LoadTexture("flower_glass")
            << TextureMipmap() << TextureMinFilter::LinearMipmapLinear
    ...
    void Render(double time) {
        ...
        model_matrix.Set(ModelMatrixf::RotationX(FullCircles(time * 0.1)));
