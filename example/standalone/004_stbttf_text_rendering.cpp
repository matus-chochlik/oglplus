...
class STBTruetypeExample : public oglplus::StandaloneExample {
private:
    oglplus::Context gl;
    ...
    oglplus::ProgramUniform<oglplus::Mat4f> rndr_projection_matrix,
      rndr_camera_matrix, rndr_layout_matrix;

    oglplus::ProgramUniform<GLfloat> rndr_time;

    oglplus::ProgramUniform<GLint> rndr_axis;
...
public:
    STBTruetypeExample(int argc, const char** argv)
      ...
      , rndr_projection_matrix(
          rndr.GetUniform<oglplus::Mat4f>("ProjectionMatrix"))
    ...
    void Render() {
        ...
        rndr_camera_matrix.Set(CamMatrixf::Orbiting(
          Vec3f(),
...
int main(int argc, char* argv[]) {
    return oglplus::GlutGlewMain<STBTruetypeExample>(
      "Example of usage of OGLplus' truetype text rendering", argc, argv);
}
