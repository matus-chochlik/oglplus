...
class BlenderMeshExample : public oglplus::StandaloneExample {
private:
    oglplus::Context gl;
...
public:
    BlenderMeshExample(int argc, const char* argv[])
      ...
      , element_count(0) {
                ...
                try {
                    ...
                    if(object_data_ptr) {
                        ...
                        if(object_data_data.StructureName() == "Mesh") {
                            ...
                            auto object_obmat_field =
                              object_data.Field<float>("obmat");
                            ...
                            auto vertex_ptr =
                              object_data_data.Field<void*>("mvert").Get();
                            ...
                            if(vertex_ptr) {
                                ...
                                auto vertex_co_field =
                                  vertex_data.Field<float>("co");
                                auto vertex_no_field =
                                  vertex_data.Field<short>("no");
                            ...
                            if(face_ptr) {
                                ...
                                for(std::size_t f = 0; f != n_faces; ++f) {
                                    ...
                                    is[5 * f + 4] =
                                      0; // primitive restart index
                                }
                                // append the values
                                idx_data.insert(
                                  idx_data.end(), is.begin(), is.end());
                            }

                            // get the poly block pointer
                            auto poly_ptr =
                              object_data_data.TryGet<void*>("mpoly", nullptr);
                            // and the loop block pointer
                            auto loop_ptr =
                              object_data_data.TryGet<void*>("mloop", nullptr);
                            ...
                            if(poly_ptr && loop_ptr) {
                                ...
                                std::size_t n_polys =
                                  poly_data.BlockElementCount();
                                // get the fields of poly and loop
                                auto poly_loopstart_field =
                                  poly_data.Field<int>("loopstart");
                                auto poly_totloop_field =
                                  poly_data.Field<int>("totloop");
        ...
        camera_distance =
          1.1f * Distance(camera_target, Vec3f(min_x, min_y, min_z)) + 1.0f;
    ...
    void Reshape() {
        ...
        Uniform<Mat4f>(prog, "ProjectionMatrix")
          .Set(CamMatrixf::PerspectiveX(Degrees(60), float(Aspect()), 1, 70));
    }
    ...
    void Render() {
        ...
        light_position.Set(CamMatrixf::Orbiting(
                             camera_target,
        ...
        gl.DrawElements(
          PrimitiveType::TriangleFan, element_count, DataType::UnsignedInt);
    }
};

int main(int argc, char* argv[]) {
    return oglplus::GlutGlewMain<BlenderMeshExample>(
      "Example of the imports::BlendFile utility usage", argc, argv);
}
