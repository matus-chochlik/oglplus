...
struct OGLOALExampleSource {
    ...
    static oglplus::Program make_prog() {
    ...
    static oglplus::shapes::ShapeWrapper create_source() {
...
struct OGLOALExampleObjects {
    ...
    static oglplus::shapes::ShapeWrapper load_objects() {
        ...
        return oglplus::shapes::ShapeWrapper(
          ...
          oglplus::shapes::ObjMesh(
            input_stream, oglplus::shapes::ObjMesh::LoadingOptions()));
    }
    ...
    OGLOALExampleObjects()
      ...
      , vao(shape.VAOForProgram(prog)) {
        ...
        rand_tex << TextureTarget::_2D << TextureMinFilter::LinearMipmapLinear
                 << TextureMagFilter::Linear << TextureWrap::Repeat
                 << images::RandomRedUByte(2048, 2048) << TextureMipmap();
    }
};

class OGLOALExample : public oglplus::StandaloneExample {
private:
    oglplus::Context gl;
...
public:
    ...
    void Reshape() {
        ...
        oglplus::Mat4f projection = oglplus::CamMatrixf::PerspectiveX(
          oglplus::Degrees(110), GLfloat(Aspect()), 1, 200);
    ...
    void Render() {
        ...
        oglplus::Mat4f camera =
          oglplus::CamMatrixf::LookingAt(camera_position, target_position);

        listener.Position(camera_position);
        listener.Velocity(camera_velocity);
        listener.Orientation(
          target_position - camera_position, oalplus::Vec3f(0.0, 1.0, 0.0));
        ...
        oglplus::Query::Activator qa(
          query, oglplus::Query::Target::SamplesPassed);
...
int main(int argc, char* argv[]) {
    return oglplus::GlutGlewMain<OGLOALExample>(
      "The usage of OGLplus with OALplus", argc, argv);
}
