 ...
 *  @brief Shows the basic usage of OGLplus with multiple contexts in GLFW3 and
 *  GLEW.
 *
...
void run() {
    std::unique_ptr<GLFWwindow, void (*)(GLFWwindow*)> window1(
      glfwCreateWindow(480, 480, "Window 1", NULL, NULL), glfwDestroyWindow);
    std::unique_ptr<GLFWwindow, void (*)(GLFWwindow*)> window2(
      glfwCreateWindow(480, 480, "Window 2", NULL, NULL), glfwDestroyWindow);
