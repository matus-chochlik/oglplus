...
class DSATextureExample : public oglplus::StandaloneExample {
private:
    oglplus::Context gl;
    ...
    oglplus::Uniform<oglplus::Mat4f> projection_matrix, camera_matrix,
      model_matrix;
...
public:
    ...
    void Render() {
        ...
        model_matrix.Set(
          ModelMatrixf::RotationX(FullCircles(FrameTime() * 0.1)));
    ...
    void Reshape() {
        ...
        projection_matrix.Set(
          CamMatrixf::PerspectiveX(Degrees(60), Aspect(), 1, 50));
    }
};

int main(int argc, char* argv[]) {
    return oglplus::GlutGlewMain<DSATextureExample>(
      "Example of EXT_direct_state_access texture usage", argc, argv);
}
