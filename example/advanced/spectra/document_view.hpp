...
public:
    ...
    const oglplus::Mat4f& ProjectionMatrix() const;

    const oglplus::Mat4f& CameraMatrix() const;

    const oglplus::Mat4f& StretchMatrix() const;

    const oglplus::Mat4f& TransfMatrix() const;
};
