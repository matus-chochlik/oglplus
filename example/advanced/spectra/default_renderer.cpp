...
class SpectraDefaultRenderer : public SpectraRenderer {
private:
...
void SpectraDefaultRenderer::CacheBgColor() {
...
void SpectraDefaultRenderer::RenderVisualCues(SpectraDocumentView& view) {
    ...
    gl.BlendFunc(
      oglplus::BlendFn::SrcAlpha, oglplus::BlendFn::OneMinusSrcAlpha);
...
void SpectraDefaultRenderer::ReinitStyle() {
    CacheBgColor();
}

bool SpectraDefaultRenderer::Interactive() {
    return true;
}
