 ...
 *  @brief Implements the classes that handle copying of raytrace output to
 * target
 *
...
RaytraceCopierDefault::RaytraceCopierDefault(
  AppData&, RaytracerTarget& target) {
...
using PFNglXCopyImageSubDataNV = void (*)(
  ::Display* dpy,
  GLXContext srcCtx,
  GLuint srcName,
  GLenum srcTarget,
