...
public:
     ...
     */
    Boolean NativeRenderable() const {
        return Boolean(
     ...
     */
    eglplus::ConfigCaveat ConfigCaveat() const {
     ...
     *  @egldefref{CONFIG_CAVEAT}
     */
    eglplus::ConfigCaveat Caveat() const {
     ...
     */
    eglplus::ColorBufferType ColorBufferType() const {
     ...
     */
    eglplus::TransparentType TransparentType() const {
     ...
     */
    Bitfield<eglplus::RenderableTypeBit> RenderableTypes() const {
     ...
     */
    Bitfield<eglplus::SurfaceTypeBit> SurfaceTypes() const {
     ...
     */
    Bitfield<eglplus::RenderableTypeBit> Conformant() const {
        return Bitfield<eglplus::RenderableTypeBit>(
...
struct ConfigValueTypeToConfigAttrib {
    ...
    static std::integral_constant<int, 4> MaxValueType();
};
