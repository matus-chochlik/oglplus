...
typedef AttributeList<SurfaceAttrib,
...
private:
	...
	static ::EGLSurface _init(Pbuffer_,
	...
	static ::EGLSurface _init(Pixmap_,
	  const Display& display,
	  const Config& config,
	...
	static ::EGLSurface _init(Window_,
	  const Display& display,
	  const Config& config,
...
public:
	 ...
	 */
	static Surface Pbuffer(const Display& display,
	  const Config& config,
	  const FinishedSurfaceAttribs& attribs) {
	 ...
	 */
	static Surface Pixmap(const Display& display,
	  const Config& config,
	  EGLNativePixmapType pixmap,
	  const FinishedSurfaceAttribs& attribs) {
	 ...
	 */
	static Surface Window(const Display& display,
	  const Config& config,
	  EGLNativeWindowType window,
	  const FinishedSurfaceAttribs& attribs) {
