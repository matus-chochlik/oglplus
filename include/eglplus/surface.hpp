...
private:
    ...
    friend ::EGLSurface GetEGLHandle(const Surface&) noexcept;
    ...
    static ::EGLSurface _init(
      ...
      const FinishedSurfaceAttribs& attribs) {
        ::EGLSurface result = EGLPLUS_EGLFUNC(CreatePbufferSurface)(
          GetEGLHandle(display), GetEGLHandle(config), attribs.Get());
    ...
    static ::EGLSurface _init(
      ...
      const FinishedSurfaceAttribs& attribs) {
        ::EGLSurface result = EGLPLUS_EGLFUNC(CreatePixmapSurface)(
          GetEGLHandle(display), GetEGLHandle(config), pixmap, attribs.Get());
    ...
    static ::EGLSurface _init(
      ...
      const FinishedSurfaceAttribs& attribs) {
        ::EGLSurface result = EGLPLUS_EGLFUNC(CreateWindowSurface)(
          GetEGLHandle(display), GetEGLHandle(config), window, attribs.Get());
...
public:
    ...
    ~Surface() {
        if(_handle != EGL_NO_SURFACE) {
            EGLPLUS_EGLFUNC(DestroySurface)(GetEGLHandle(_display), _handle);
    ...
    static Surface Pbuffer(
      ...
      const Config& config,
      const FinishedSurfaceAttribs& attribs) {
        return Surface(Pbuffer_(), display, config, attribs);
    }
    ...
    static Surface Pixmap(
      ...
      EGLNativePixmapType pixmap,
      const FinishedSurfaceAttribs& attribs) {
        return Surface(Pixmap_(), display, config, pixmap, attribs);
    }
    ...
    static Surface Window(
      ...
      EGLNativeWindowType window,
      const FinishedSurfaceAttribs& attribs) {
        return Surface(Window_(), display, config, window, attribs);
    }
    ...
    Boolean SwapBuffers() {
        Boolean result(
          EGLPLUS_EGLFUNC(SwapBuffers)(GetEGLHandle(_display), _handle),
          std::nothrow);
    ...
    Boolean CopyBuffers(EGLNativePixmapType target) {
        Boolean result(
          EGLPLUS_EGLFUNC(CopyBuffers)(GetEGLHandle(_display), _handle, target),
          std::nothrow);
     ...
     */
    eglplus::RenderBuffer RenderBuffer() const {
        return eglplus::RenderBuffer(GetAttrib(SurfaceAttrib::RenderBuffer));
    }
    ...
    void RenderBuffer(eglplus::RenderBuffer render_buffer) {
        Attrib(SurfaceAttrib::RenderBuffer, EGLint(render_buffer));
    }
     ...
     */
    eglplus::MultisampleResolve MultisampleResolve() const {
    ...
    void MultisampleResolve(eglplus::MultisampleResolve value) {
        Attrib(SurfaceAttrib::MultisampleResolve, EGLint(value));
    }
     ...
     */
    eglplus::SwapBehavior SwapBehavior() const {
    ...
    void SwapBehavior(eglplus::SwapBehavior value) {
        Attrib(SurfaceAttrib::SwapBehavior, EGLint(value));
    }
     ...
     */
    eglplus::TextureTarget TextureTarget() const {
     ...
     */
    eglplus::TextureFormat TextureFormat() const {
     ...
     */
    eglplus::GLColorspace GLColorspace() const {
     ...
     */
    eglplus::VGColorspace VGColorspace() const {
     ...
     */
    eglplus::VGAlphaFormat VGAlphaFormat() const {
        return eglplus::VGAlphaFormat(
          EGLenum(GetAttrib(SurfaceAttrib::VGAlphaFormat)));
    }
};

inline ::EGLSurface GetEGLHandle(const Surface& surface) noexcept {
