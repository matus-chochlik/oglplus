...
class DSAVertexArrayAttrib : public ProgVarCommonOps<tag::VertexAttrib> {
private:
    GLuint _vao;
...
public:
     ...
     */
    DSAVertexArrayAttrib(VertexArrayName vao, VertexAttribSlot location)
    ...
    DSAVertexArrayAttrib& Enable() {
        OGLPLUS_GLFUNC(EnableVertexArrayAttrib)(_vao, GLuint(_location));
    ...
    DSAVertexArrayAttrib& Disable() {
        OGLPLUS_GLFUNC(DisableVertexArrayAttrib)(_vao, GLuint(_location));
    ...
    DSAVertexArrayAttrib& VertexBuffer(
      BufferName buffer, GLintptr offset, GLsizei stride) {
        OGLPLUS_GLFUNC(VertexArrayVertexBuffer)
        (_vao, GLuint(_location), GetGLName(buffer), offset, stride);
        OGLPLUS_CHECK(
          VertexArrayVertexBuffer,
          ObjectPairError,
          Subject(buffer).Object(VertexArrayName(_vao)));
        return *this;
    }
    ...
    DSAVertexArrayAttrib& Format(
      ...
      GLuint relative_offset) {
        ...
        OGLPLUS_CHECK(
          ...
          ObjectError,
          Object(VertexArrayName(_vao)).EnumParam(data_type));
        return *this;
    }
    ...
    DSAVertexArrayAttrib& IFormat(
      GLint values_per_vertex, DataType data_type, GLuint relative_offset) {
