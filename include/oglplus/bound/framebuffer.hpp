...
public:
    ...
    FramebufferStatus Status() const {
        return ExplicitOps::Status(this->target);
    }
    ...
    bool IsComplete() const {
        return ExplicitOps::IsComplete(this->target);
    }
    ...
    const BoundObjOps& HandleIncompleteError(FramebufferStatus status) const {
        ExplicitOps::HandleIncompleteError(this->target, status);
        return *this;
    }
     ...
     */
    const BoundObjOps& Complete() const {
        ExplicitOps::Complete(this->target);
        return *this;
    }
    ...
    const BoundObjOps& AttachRenderbuffer(
      ...
      RenderbufferName renderbuffer) const {
        ExplicitOps::AttachRenderbuffer(this->target, attachment, renderbuffer);
        return *this;
    }
    ...
    const BoundObjOps& AttachColorRenderbuffer(
      ...
      RenderbufferName renderbuffer) const {
        ExplicitOps::AttachColorRenderbuffer(
          this->target, attachment_no, renderbuffer);
        return *this;
    }
    ...
    const BoundObjOps& AttachTexture(
      ...
      TextureName texture,
      GLint level) const {
        ExplicitOps::AttachTexture(this->target, attachment, texture, level);
        return *this;
    }
    ...
    const BoundObjOps& AttachColorTexture(
      ...
      GLint level) const {
        ExplicitOps::AttachColorTexture(
          this->target, attachment_no, texture, level);
        return *this;
    }
    ...
    const BoundObjOps& AttachTexture3D(
      ...
      GLint layer) const {
        ExplicitOps::AttachTexture3D(
          this->target, attachment, textarget, texture, level, layer);
        return *this;
    }
    ...
    const BoundObjOps& Invalidate(
      const EnumArray<ExplicitOps::Property::Buffer>& buffers) const {
        ExplicitOps::Invalidate(this->target, buffers);
        return *this;
    }
     ...
     */
    const BoundObjOps& Invalidate(
      SizeType count, const ExplicitOps::Property::Buffer* buffers) const {
        ExplicitOps::Invalidate(this->target, count, buffers);
        return *this;
    }
#endif // GL_VERSION_4_3 GL_ARB_invalidate_subdata
    ...
    const BoundObjOps& Invalidate(
      ...
      SizeType height) const {
        ExplicitOps::Invalidate(this->target, buffers, x, y, width, height);
        return *this;
    }
#endif // GL_VERSION_4_3 GL_ARB_invalidate_subdata
    ...
    const BoundObjOps& Invalidate(
      ...
      SizeType height) const {
        ExplicitOps::Invalidate(
          this->target, count, buffers, x, y, width, height);
        return *this;
    }
#endif // GL_VERSION_4_3 GL_ARB_invalidate_subdata
