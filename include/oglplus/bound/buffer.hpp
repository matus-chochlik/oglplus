...
public:
    ...
    Boolean Mapped() const {
        return ExplicitOps::Mapped(this->target);
    }
    ...
    const BoundObjOps& Resize(
      BufferSize size, BufferUsage usage = BufferUsage::StaticDraw) const {
        ExplicitOps::Resize(this->target, size, usage);
        return *this;
    }
    ...
    const BoundObjOps& Data(
      ...
      BufferUsage usage = BufferUsage::StaticDraw) const {
        ExplicitOps::Data(this->target, data, usage);
        return *this;
    }
    ...
    const BoundObjOps& RawData(
      ...
      const GLvoid* data,
      BufferUsage usage = BufferUsage::StaticDraw) const {
        ExplicitOps::RawData(this->target, size, data, usage);
        return *this;
    }
    ...
    const BoundObjOps& Data(
      ...
      const GLtype* data,
      BufferUsage usage = BufferUsage::StaticDraw) const {
        ExplicitOps::Data(this->target, count, data, usage);
        return *this;
    }
    ...
    const BoundObjOps& SubData(
      BufferSize offset, const BufferData& data) const {
        ExplicitOps::SubData(this->target, offset, data);
        return *this;
    }
    ...
    template <typename GLtype>
    const BoundObjOps& SubData(
      BufferSize offset, SizeType count, const GLtype* data) const {
        ExplicitOps::SubData(this->target, offset, count, data);
        return *this;
    }
    ...
    const BoundObjOps& ClearData(
      ...
      const GLtype* data) const {
        ExplicitOps::ClearData(this->target, internal_format, format, data);
        return *this;
    }
    ...
    const BoundObjOps& ClearSubData(
      ...
      const GLtype* data) const {
        ExplicitOps::ClearSubData(
          this->target, internal_format, offset, size, format, data);
        return *this;
    }
#endif // GL_VERSION_4_3
    ...
    const BoundObjOps& Storage(
      const BufferData& data, Bitfield<BufferStorageBit> flags) const {
        ExplicitOps::Storage(this->target, data, flags);
        return *this;
    }
    ...
    const BoundObjOps& Storage(
      ...
      Bitfield<BufferStorageBit> flags) const {
        ExplicitOps::Storage(this->target, size, data, flags);
        return *this;
    }
#endif // GL_VERSION_4_4 GL_ARB_buffer_storage
     ...
     */
    Boolean ImmutableStorage() const {
        return ExplicitOps::ImmutableStorage(this->target);
    }
#endif // GL_VERSION_4_4 GL_ARB_buffer_storage
     ...
     */
    Bitfield<BufferStorageBit> StorageFlags() const {
        return ExplicitOps::StorageFlags(this->target);
    }
#endif // GL_VERSION_4_4 GL_ARB_buffer_storage
    ...
    const BoundObjOps& PageCommitment(
      BufferSize offset, BufferSize size, Boolean commit) const {
        ExplicitOps::PageCommitment(this->target, offset, size, commit);
        return *this;
    }
     ...
     */
    SizeType Size() const {
        return ExplicitOps::Size(this->target);
    }
    ...
    BufferUsage Usage() const {
        return ExplicitOps::Usage(this->target);
    }
    ...
    Bitfield<BufferMapAccess> Access() const {
        return ExplicitOps::Access(this->target);
    }
    ...
    const BoundObjOps& MakeResident(AccessSpecifier access) const {
        ExplicitOps::MakeResident(this->target, access);
        return *this;
    }
    ...
    const BoundObjOps& MakeNonResident() const {
        ExplicitOps::MakeNonResident(this->target);
        return *this;
    }
#endif // GL_NV_shader_buffer_load
    ...
    BufferGPUAddress GPUAddress() const {
        return ExplicitOps::GPUAddress(this->target);
    }
#endif // GL_NV_shader_buffer_load
