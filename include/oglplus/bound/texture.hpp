...
public:
    ...
    GLfloat GetFloatParam(GLenum query) const {
        return ExplicitOps::GetFloatParam(this->target, query);
    }
    ...
    GLint GetIntParam(GLint level, GLenum query) const {
        return ExplicitOps::GetIntParam(this->target, level, query);
    }
    ...
    GLfloat GetFloatParam(GLint level, GLenum query) const {
        return ExplicitOps::GetFloatParam(this->target, level, query);
    }
    ...
    SizeType Width(GLint level = 0) const {
        return ExplicitOps::Width(this->target, level);
    }
    ...
    SizeType Height(GLint level = 0) const {
        return ExplicitOps::Height(this->target, level);
    }
    ...
    SizeType Depth(GLint level = 0) const {
        return ExplicitOps::Depth(this->target, level);
    }
    ...
    PixelDataType RedType(GLint level = 0) const {
        return ExplicitOps::RedType(this->target, level);
    }
    ...
    PixelDataType GreenType(GLint level = 0) const {
        return ExplicitOps::GreenType(this->target, level);
    }
    ...
    PixelDataType BlueType(GLint level = 0) const {
        return ExplicitOps::BlueType(this->target, level);
    }
    ...
    PixelDataType AlphaType(GLint level = 0) const {
        return ExplicitOps::AlphaType(this->target, level);
    }
    ...
    PixelDataType DepthType(GLint level = 0) const {
        return ExplicitOps::DepthType(this->target, level);
    }
    ...
    SizeType RedSize(GLint level = 0) const {
        return ExplicitOps::RedSize(this->target, level);
    }
    ...
    SizeType GreenSize(GLint level = 0) const {
        return ExplicitOps::GreenSize(this->target, level);
    }
    ...
    SizeType BlueSize(GLint level = 0) const {
        return ExplicitOps::BlueSize(this->target, level);
    }
    ...
    SizeType AlphaSize(GLint level = 0) const {
        return ExplicitOps::AlphaSize(this->target, level);
    }
    ...
    SizeType DepthSize(GLint level = 0) const {
        return ExplicitOps::DepthSize(this->target, level);
    }
    ...
    SizeType StencilSize(GLint level = 0) const {
        return ExplicitOps::StencilSize(this->target, level);
    }
    ...
    SizeType SharedSize(GLint level = 0) const {
        return ExplicitOps::SharedSize(this->target, level);
    }
    ...
    SizeType CompressedImageSize(GLint level = 0) const {
        return ExplicitOps::CompressedImageSize(this->target, level);
    }
    ...
    PixelDataInternalFormat InternalFormat(GLint level = 0) const {
        return ExplicitOps::InternalFormat(this->target, level);
    }
    ...
    const BoundObjOps& GetImage(
      GLint level, PixelDataFormat format, const OutputData& dest) const {
        ExplicitOps::GetImage(this->target, level, format, dest);
        return *this;
    }
    ...
    const BoundObjOps& GetImage(
      ...
      SizeType size,
      GLvoid* buffer) const {
        ExplicitOps::GetImage(this->target, level, format, type, size, buffer);
        return *this;
    }
    ...
    const BoundObjOps& GetCompressedImage(
      GLint level, const OutputData& dest) const {
        ExplicitOps::GetCompressedImage(this->target, level, dest);
        return *this;
    }
     ...
     */
    const BoundObjOps& GetCompressedImage(
      GLint level, SizeType size, GLubyte* buffer) const {
        ExplicitOps::GetCompressedImage(this->target, level, size, buffer);
        return *this;
    }
     ...
     */
    const BoundObjOps& GetCompressedImage(
      GLint level, std::vector<GLubyte>& dest) const {
        ExplicitOps::GetCompressedImage(this->target, level, dest);
        return *this;
    }
     ...
     */
    const BoundObjOps& Image3D(
      const images::Image& image, GLint level = 0, GLint border = 0) const {
        ExplicitOps::Image3D(this->target, image, level, border);
        return *this;
    }
    ...
    const BoundObjOps& SubImage3D(
      ...
      GLint level = 0) const {
        ExplicitOps::SubImage3D(
          this->target, image, xoffs, yoffs, zoffs, level);
        return *this;
    }
    ...
    const BoundObjOps& Image2D(
      const images::Image& image, GLint level = 0, GLint border = 0) const {
        ExplicitOps::Image2D(this->target, image, level, border);
        return *this;
    }
    ...
    const BoundObjOps& SubImage2D(
      ...
      const void* data) const {
        ExplicitOps::SubImage2D(
          this->target, level, xoffs, yoffs, width, height, format, type, data);
        return *this;
    }
    ...
    const BoundObjOps& SubImage2D(
      ...
      GLint yoffs,
      GLint level = 0) const {
        ExplicitOps::SubImage2D(this->target, image, xoffs, yoffs, level);
        return *this;
    }
    ...
    const BoundObjOps& Image1D(
      const images::Image& image, GLint level = 0, GLint border = 0) const {
        ExplicitOps::Image1D(this->target, image, level, border);
        return *this;
    }
    ...
    const BoundObjOps& SubImage1D(
      ...
      const void* data) const {
        ExplicitOps::SubImage1D(
          this->target, level, xoffs, width, format, type, data);
        return *this;
    }
     ...
     */
    const BoundObjOps& SubImage1D(
      const images::Image& image, GLint xoffs, GLint level = 0) const {
        ExplicitOps::SubImage1D(this->target, image, xoffs, level);
        return *this;
    }
    ...
    const BoundObjOps& Image(
      const images::Image& image, GLint level = 0, GLint border = 0) const {
        ExplicitOps::Image(this->target, image, level, border);
        return *this;
    }
    ...
    const BoundObjOps& Image(
      ...
      GLint border = 0) const {
        ExplicitOps::Image(this->target, image_spec, level, border);
        return *this;
    }
    ...
    const BoundObjOps& CopyImage2D(
      ...
      GLint border) const {
        ExplicitOps::CopyImage2D(
          this->target, level, internal_format, x, y, width, height, border);
        return *this;
    }
    ...
    const BoundObjOps& CopyImage1D(
      ...
      GLint border) const {
        ExplicitOps::CopyImage1D(
          this->target, level, internal_format, x, y, width, border);
        return *this;
    }
    ...
    const BoundObjOps& CopySubImage3D(
      ...
      SizeType height) const {
        ExplicitOps::CopySubImage3D(
          this->target, level, xoffs, yoffs, zoffs, x, y, width, height);
        return *this;
    }
    ...
    const BoundObjOps& CopySubImage2D(
      ...
      SizeType height) const {
        ExplicitOps::CopySubImage2D(
          this->target, level, xoffs, yoffs, x, y, width, height);
        return *this;
    }
    ...
    const BoundObjOps& CopySubImage1D(
      GLint level, GLint xoffs, GLint x, GLint y, SizeType width) const {
        ExplicitOps::CopySubImage1D(this->target, level, xoffs, x, y, width);
        return *this;
    }
    ...
    const BoundObjOps& CompressedSubImage1D(
      ...
      const void* data) const {
        ExplicitOps::CompressedSubImage1D(
          this->target, level, xoffs, width, format, image_size, data);
        return *this;
    }
    ...
    const BoundObjOps& Image3DMultisample(
      ...
      SizeType height,
      SizeType depth,
      Boolean fixed_sample_locations) const {
    ...
    const BoundObjOps& Buffer(
      PixelDataInternalFormat internal_format, BufferName buffer) const {
        ExplicitOps::Buffer(this->target, internal_format, buffer);
        return *this;
    }
    ...
    const BoundObjOps& BufferRange(
      ...
      BigSizeType size) const {
        ExplicitOps::BufferRange(
          this->target, internal_format, buffer, offset, size);
        return *this;
    }
    ...
    const BoundObjOps& Storage1D(
      ...
      SizeType width) const {
        ExplicitOps::Storage1D(this->target, levels, internal_format, width);
        return *this;
    }
    ...
    const BoundObjOps& Storage2D(
      ...
      SizeType height) const {
        ExplicitOps::Storage2D(
          this->target, levels, internal_format, width, height);
        return *this;
    }
#endif // GL_VERSION_4_2 GL_ARB_texture_storage
    ...
    const BoundObjOps& Storage3D(
      ...
      SizeType depth) const {
        ExplicitOps::Storage3D(
          this->target, levels, internal_format, width, height, depth);
        return *this;
    }
#endif // GL_VERSION_4_2 GL_ARB_texture_storage
    ...
    GLuint BaseLevel() const {
        return ExplicitOps::BaseLevel(this->target);
    }

    /** Wrapper for Texture::BaseLevel()
     *  @see Texture::BaseLevel()
     */
    const BoundObjOps& BaseLevel(GLint level) const {
        ExplicitOps::BaseLevel(this->target, level);
        return *this;
    }
    ...
    Vector<GLfloat, 4> BorderColor(TypeTag<GLfloat> _auto_param_2) const {
        return ExplicitOps::BorderColor(this->target, _auto_param_2);
    }
    ...
    const BoundObjOps& BorderColor(Vector<GLfloat, 4> color) const {
        ExplicitOps::BorderColor(this->target, color);
        return *this;
    }
    ...
    TextureCompareMode CompareMode() const {
        return ExplicitOps::CompareMode(this->target);
    }
    ...
    const BoundObjOps& CompareMode(TextureCompareMode mode) const {
        ExplicitOps::CompareMode(this->target, mode);
        return *this;
    }
    ...
    CompareFunction CompareFunc() const {
        return ExplicitOps::CompareFunc(this->target);
    }
    ...
    const BoundObjOps& CompareFunc(CompareFunction func) const {
        ExplicitOps::CompareFunc(this->target, func);
        return *this;
    }
    ...
    GLfloat LODBias() const {
        return ExplicitOps::LODBias(this->target);
    }
    ...
    const BoundObjOps& LODBias(GLfloat value) const {
        ExplicitOps::LODBias(this->target, value);
        return *this;
    }
    ...
    const BoundObjOps& Filter(TextureFilter filter) const {
        ExplicitOps::Filter(this->target, filter);
        return *this;
    }
    ...
    TextureMagFilter MagFilter() const {
        return ExplicitOps::MagFilter(this->target);
    }
    ...
    const BoundObjOps& MagFilter(TextureMagFilter filter) const {
        ExplicitOps::MagFilter(this->target, filter);
        return *this;
    }
    ...
    TextureMinFilter MinFilter() const {
        return ExplicitOps::MinFilter(this->target);
    }
    ...
    const BoundObjOps& MinFilter(TextureMinFilter filter) const {
        ExplicitOps::MinFilter(this->target, filter);
        return *this;
    }
    ...
    GLfloat MinLOD() const {
        return ExplicitOps::MinLOD(this->target);
    }
    ...
    const BoundObjOps& MinLOD(GLfloat value) const {
        ExplicitOps::MinLOD(this->target, value);
        return *this;
    }
    ...
    GLfloat MaxLOD() const {
        return ExplicitOps::MaxLOD(this->target);
    }
    ...
    const BoundObjOps& MaxLOD(GLfloat value) const {
        ExplicitOps::MaxLOD(this->target, value);
        return *this;
    }
    ...
    GLint MaxLevel() const {
        return ExplicitOps::MaxLevel(this->target);
    }
    ...
    const BoundObjOps& MaxLevel(GLint value) const {
        ExplicitOps::MaxLevel(this->target, value);
        return *this;
    }
    ...
    GLfloat MaxAnisotropy() const {
        return ExplicitOps::MaxAnisotropy(this->target);
    }
    ...
    GLfloat Anisotropy() const {
        return ExplicitOps::Anisotropy(this->target);
    }
    ...
    const BoundObjOps& Anisotropy(GLfloat value) const {
        ExplicitOps::Anisotropy(this->target, value);
        return *this;
    }
    ...
    TextureSwizzle Swizzle(TextureSwizzleCoord coord) const {
        return ExplicitOps::Swizzle(this->target, coord);
    }
    ...
    const BoundObjOps& Swizzle(
      TextureSwizzleCoord coord, TextureSwizzle mode) const {
        ExplicitOps::Swizzle(this->target, coord, mode);
        return *this;
    }
#endif // GL_VERSION_3_3 GL_ARB_texture_swizzle
    ...
    TextureSwizzle SwizzleR() const {
        return ExplicitOps::SwizzleR(this->target);
    }
#endif // GL_VERSION_3_3 GL_ARB_texture_swizzle
    ...
    const BoundObjOps& SwizzleR(TextureSwizzle mode) const {
        ExplicitOps::SwizzleR(this->target, mode);
        return *this;
    }
#endif // GL_VERSION_3_3 GL_ARB_texture_swizzle
    ...
    TextureSwizzle SwizzleG() const {
        return ExplicitOps::SwizzleG(this->target);
    }
#endif // GL_VERSION_3_3 GL_ARB_texture_swizzle
    ...
    const BoundObjOps& SwizzleG(TextureSwizzle mode) const {
        ExplicitOps::SwizzleG(this->target, mode);
        return *this;
    }
#endif // GL_VERSION_3_3 GL_ARB_texture_swizzle
    ...
    TextureSwizzle SwizzleB() const {
        return ExplicitOps::SwizzleB(this->target);
    }
#endif // GL_VERSION_3_3 GL_ARB_texture_swizzle
    ...
    const BoundObjOps& SwizzleB(TextureSwizzle mode) const {
        ExplicitOps::SwizzleB(this->target, mode);
        return *this;
    }
#endif // GL_VERSION_3_3 GL_ARB_texture_swizzle
    ...
    TextureSwizzle SwizzleA() const {
        return ExplicitOps::SwizzleA(this->target);
    }
#endif // GL_VERSION_3_3 GL_ARB_texture_swizzle
    ...
    const BoundObjOps& SwizzleA(TextureSwizzle mode) const {
        ExplicitOps::SwizzleA(this->target, mode);
        return *this;
    }
#endif // GL_VERSION_3_3 GL_ARB_texture_swizzle
    ...
    TextureSwizzleTuple SwizzleRGBA() const {
        return ExplicitOps::SwizzleRGBA(this->target);
    }
#endif // GL_VERSION_3_3 GL_ARB_texture_swizzle
    ...
    const BoundObjOps& SwizzleRGBA(TextureSwizzle mode) const {
        ExplicitOps::SwizzleRGBA(this->target, mode);
        return *this;
    }
#endif // GL_VERSION_3_3 GL_ARB_texture_swizzle
    ...
    const BoundObjOps& SwizzleRGBA(
      ...
      TextureSwizzle mode_a) const {
        ExplicitOps::SwizzleRGBA(this->target, mode_r, mode_g, mode_b, mode_a);
        return *this;
    }
#endif // GL_VERSION_3_3 GL_ARB_texture_swizzle
    ...
    const BoundObjOps& SwizzleRGBA(const TextureSwizzleTuple& modes) const {
        ExplicitOps::SwizzleRGBA(this->target, modes);
        return *this;
    }
#endif // GL_VERSION_3_3 GL_ARB_texture_swizzle
    ...
    TextureWrap Wrap(TextureWrapCoord coord) const {
        return ExplicitOps::Wrap(this->target, coord);
    }
    ...
    const BoundObjOps& Wrap(TextureWrapCoord coord, TextureWrap mode) const {
        ExplicitOps::Wrap(this->target, coord, mode);
        return *this;
    }
    ...
    TextureWrap WrapS() const {
        return ExplicitOps::WrapS(this->target);
    }
    ...
    const BoundObjOps& WrapS(TextureWrap mode) const {
        ExplicitOps::WrapS(this->target, mode);
        return *this;
    }
    ...
    TextureWrap WrapT() const {
        return ExplicitOps::WrapT(this->target);
    }
    ...
    const BoundObjOps& WrapT(TextureWrap mode) const {
        ExplicitOps::WrapT(this->target, mode);
        return *this;
    }
    ...
    TextureWrap WrapR() const {
        return ExplicitOps::WrapR(this->target);
    }
    ...
    const BoundObjOps& WrapR(TextureWrap mode) const {
        ExplicitOps::WrapR(this->target, mode);
        return *this;
    }
     ...
     *  @see Texture::Wrap()
     */
    const BoundObjOps& Wrap(TextureWrap mode) const {
        ExplicitOps::Wrap(this->target, mode);
        return *this;
    }
    ...
    PixelDataFormat DepthStencilMode() const {
        return ExplicitOps::DepthStencilMode(this->target);
    }
#endif // GL_VERSION_4_3
    ...
    const BoundObjOps& DepthStencilMode(PixelDataFormat mode) const {
        ExplicitOps::DepthStencilMode(this->target, mode);
        return *this;
    }
#endif // GL_VERSION_4_3
    ...
    Boolean Seamless() const {
        return ExplicitOps::Seamless(this->target);
    }
     ...
     *  @see Texture::Seamless()
     */
    const BoundObjOps& Seamless(Boolean enable) const {
        ExplicitOps::Seamless(this->target, enable);
        return *this;
    }
#endif // GL_ARB_seamless_cubemap_per_texture
     ...
     */
    const BoundObjOps& GenerateMipmap() const {
        ExplicitOps::GenerateMipmap(this->target);
        return *this;
    }
