...
class Hint : public SettingStack<HintOption, Nothing> {
private:
    static HintOption _do_get(Nothing) {
        return context::Hints::Hint(Target);
    }

    static void _do_set(HintOption option, Nothing) {
...
class HintState {
public:
    oglplus::enums::EnumToClass<Nothing, HintTarget, aux::Hint> Hints;
};
