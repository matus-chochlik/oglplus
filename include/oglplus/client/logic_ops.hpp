...
class LogicOp : public SettingStack<ColorLogicOperation, Nothing> {
private:
    static ColorLogicOperation _do_get(Nothing) {
        return context::LogicOpState::LogicOpMode();
    }

    static void _do_set(ColorLogicOperation op, Nothing) {
