...
public:
     ...
     */
    static Bitfield<ContextProfileBit> ProfileMask() {
        GLint result = 0;
     ...
     */
    static Bitfield<ContextFlagBit> Flags() {
        GLint result = 0;
     ...
     */
    static ContextReleaseBehavior ReleaseBehavior() {
        GLint result = 0;
     ...
     */
    static oglplus::ResetNotificationStrategy ResetNotificationStrategy() {
        GLint result = 0;
        OGLPLUS_GLFUNC(GetIntegerv)(GL_RESET_NOTIFICATION_STRATEGY, &result);
        OGLPLUS_VERIFY_SIMPLE(GetIntegerv);
     ...
     */
    static oglplus::GraphicsResetStatus GraphicsResetStatus() {
