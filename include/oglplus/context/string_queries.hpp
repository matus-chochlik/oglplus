...
public:
    ...
    StrCRef Front() const {
        assert(!Empty());
        const GLubyte* result = OGLPLUS_GLFUNC(GetStringi)(_param, _index);
...
public:
    ...
    static GLuint NumShadingLanguageVersions() {
        GLint result = 0;
        OGLPLUS_GLFUNC(GetIntegerv)(GL_NUM_SHADING_LANGUAGE_VERSIONS, &result);
    ...
    static const GLubyte* ShadingLanguageVersion(GLuint index) {
        const GLubyte* result =
          OGLPLUS_GLFUNC(GetStringi)(GL_SHADING_LANGUAGE_VERSION, index);
        OGLPLUS_VERIFY_SIMPLE(GetStringi);
        return result;
    }
     ...
     */
    static Range<String> ShadingLanguageVersions();
#elif GL_VERSION_4_3
    static aux::StrQueryRange ShadingLanguageVersions() {
        return aux::StrQueryRange(
          NumShadingLanguageVersions(), GL_SHADING_LANGUAGE_VERSION);
    }
#endif
    ...
    static const GLubyte* Extensions(GLuint index) {
        const GLubyte* result =
          OGLPLUS_GLFUNC(GetStringi)(GL_EXTENSIONS, index);
        OGLPLUS_VERIFY_SIMPLE(GetStringi);
        return result;
    }
     ...
     *  @gldefref{EXTENSIONS}
     */
    static Range<StrCRef> Extensions();
#else
    static aux::StrQueryRange Extensions() {
        return aux::StrQueryRange(NumExtensions(), GL_EXTENSIONS);
    }
#endif
};
