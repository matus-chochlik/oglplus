...
public:
    ...
    static void ClearColorBuffer(GLint draw_buffer, const GLint* value) {
        OGLPLUS_GLFUNC(ClearBufferiv)(GL_COLOR, draw_buffer, value);
        OGLPLUS_CHECK(ClearBufferiv, Error, Index(draw_buffer));
    }
    ...
    static void ClearColorBuffer(
      ColorBuffer buffer, GLint draw_buffer, const GLint* value) {
        OGLPLUS_GLFUNC(ClearBufferiv)(GLenum(buffer), draw_buffer, value);
        OGLPLUS_CHECK(
          ClearBufferiv, Error, EnumParam(buffer).Index(draw_buffer));
    }
    ...
    static void ClearColorBuffer(GLint draw_buffer, const GLuint* value) {
        OGLPLUS_GLFUNC(ClearBufferuiv)(GL_COLOR, draw_buffer, value);
        OGLPLUS_CHECK(ClearBufferuiv, Error, Index(draw_buffer));
    }
     ...
     */
    static void ClearColorBuffer(
      ColorBuffer buffer, GLint draw_buffer, const GLuint* value) {
        OGLPLUS_GLFUNC(ClearBufferuiv)(GLenum(buffer), draw_buffer, value);
        OGLPLUS_CHECK(
          ClearBufferuiv, Error, EnumParam(buffer).Index(draw_buffer));
    }
    ...
    static void ClearColorBuffer(GLint draw_buffer, const GLfloat* value) {
        OGLPLUS_GLFUNC(ClearBufferfv)(GL_COLOR, draw_buffer, value);
        OGLPLUS_CHECK(ClearBufferfv, Error, Index(draw_buffer));
    }
     ...
     */
    static void ClearColorBuffer(
      ColorBuffer buffer, GLint draw_buffer, const GLfloat* value) {
        OGLPLUS_GLFUNC(ClearBufferfv)(GLenum(buffer), draw_buffer, value);
        OGLPLUS_CHECK(
          ClearBufferfv, Error, EnumParam(buffer).Index(draw_buffer));
    }
    ...
    static void ClearStencilBuffer(GLfloat depth_value, GLint stencil_value) {
        ...
        (GL_DEPTH_STENCIL, 0, depth_value, stencil_value);
