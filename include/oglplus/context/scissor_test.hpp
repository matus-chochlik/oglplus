...
public:
     ...
     */
    static void Scissor(
      GLint left, GLint bottom, SizeType width, SizeType height) {
     ...
     */
    static ScissorRectangle ScissorBox() {
        ScissorRectangle result;
        OGLPLUS_GLFUNC(GetIntegerv)(GL_SCISSOR_BOX, result._v);
    ...
    static void Scissor(
      ...
      SizeType height) {
        ...
        (GLuint(viewport), left, bottom, width, height);
        OGLPLUS_CHECK(ScissorIndexed, Error, Index(GLuint(viewport)));
    }

    static void Scissor(ViewportIndex viewport, const ScissorRectangle& rect) {
        OGLPLUS_GLFUNC(ScissorIndexed)
        (GLuint(viewport),
         rect.Left(),
         rect.Bottom(),
    ...
    static void Scissor(ViewportIndex viewport, GLint* v) {
        ...
        OGLPLUS_CHECK(ScissorIndexedv, Error, Index(GLuint(viewport)));
    }
    ...
    static ScissorRectangle ScissorBox(ViewportIndex viewport) {
        ...
        (GL_SCISSOR_BOX, GLuint(viewport), result._v);
        OGLPLUS_CHECK(GetIntegeri_v, Error, Index(GLuint(viewport)));
        return result;
    }
#endif
};
