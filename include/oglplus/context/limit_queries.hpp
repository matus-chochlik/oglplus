...
public:
    ...
    static typename enums::EnumAssocGLType<LimitQuery, Query>::Type Limit() {
        return Limit(
          Query,
          TypeTag<typename enums::EnumAssocType<LimitQuery, Query>::Type>());
    }
    ...
    static void ThrowIfOverLimit(
      LimitQuery limit, GLint value, GLint max_limit) {
