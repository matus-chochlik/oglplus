...
struct BlendEquationSeparate {
	...
	BlendEquationSeparate(void) noexcept {
	}
	...
	BlendEquation RGB(void) const noexcept {
		return BlendEquation(GLenum(_v[0]));
	}

	BlendEquation Alpha(void) const noexcept {
		return BlendEquation(GLenum(_v[1]));
	}

	bool Separate(void) const noexcept {
		return _v[0] != _v[1];
	}
...
struct BlendFunctionSeparate {
	...
	BlendFunctionSeparate(void) noexcept {
	}

	BlendFunctionSeparate(BlendFunction src_rgb,
	...
	BlendFunction SrcRGB(void) const noexcept {
		return BlendFunction(GLenum(_v[0]));
	}

	BlendFunction SrcAlpha(void) const noexcept {
		return BlendFunction(GLenum(_v[1]));
	}

	BlendFunction DstRGB(void) const noexcept {
		return BlendFunction(GLenum(_v[2]));
	}

	BlendFunction DstAlpha(void) const noexcept {
...
public:
	 ...
	 */
	static void BlendEquation(OneOf<GLenum,
	  std::tuple<oglplus::BlendEquation, oglplus::BlendEquationAdvanced>> eq) {
	 ...
	 */
	static void BlendEquation(DrawBufferIndex buffer,
	  OneOf<GLenum,
	 ...
	 */
	static void BlendEquationSeparate(DrawBufferIndex buffer,
	 ...
	 */
	static void BlendFuncSeparate(BlendFunction src_rgb,
	  BlendFunction dst_rgb,
	  BlendFunction src_alpha,
	 ...
	 */
	static void BlendFuncSeparate(DrawBufferIndex buffer,
