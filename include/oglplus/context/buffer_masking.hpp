...
public:
    ...
    static void ColorMask(Boolean r, Boolean g, Boolean b, Boolean a) {
        OGLPLUS_GLFUNC(ColorMask)(r._get(), g._get(), b._get(), a._get());
    ...
    static void ColorMask(
      DrawBufferIndex buffer, Boolean r, Boolean g, Boolean b, Boolean a) {
        OGLPLUS_GLFUNC(ColorMaski)
        (GLuint(buffer), r._get(), g._get(), b._get(), a._get());
        OGLPLUS_VERIFY(ColorMaski, Error, Index(GLuint(buffer)));
    }
    ...
    static oglplus::context::RGBAMask ColorWriteMask() {
        oglplus::context::RGBAMask result;
        OGLPLUS_GLFUNC(GetIntegerv)(GL_COLOR_WRITEMASK, result._v);
    ...
    static oglplus::context::RGBAMask ColorWriteMask(DrawBufferIndex buffer) {
        ...
        (GL_COLOR_WRITEMASK, GLuint(buffer), result._v);
     ...
     */
    static Boolean DepthWriteMask() {
        Boolean result;
        OGLPLUS_GLFUNC(GetIntegerv)(GL_DEPTH_WRITEMASK, result._ptr());
        OGLPLUS_VERIFY_SIMPLE(GetIntegerv);
        return result;
    }
    ...
    static GLuint StencilWriteMask(bool backface = false) {
        ...
        (backface ? GL_STENCIL_BACK_WRITEMASK : GL_STENCIL_WRITEMASK, &result);
        OGLPLUS_VERIFY_SIMPLE(GetIntegerv);
