...
public:
     ...
     */
    static oglplus::PolygonMode PolygonModeFront() {
        GLint result[2];
     ...
     *  @gldefref{POLYGON_MODE}
     */
    static oglplus::PolygonMode PolygonModeBack() {
        GLint result[2];
        OGLPLUS_GLFUNC(GetIntegerv)(GL_POLYGON_MODE, result);
        OGLPLUS_VERIFY_SIMPLE(GetIntegerv);
    ...
    static PolygonModes PolygonMode() {
        PolygonModes result;
    ...
    static PolygonOffsPara PolygonOffset() {
    ...
    static FragDataSlot FragmentCoverageColor() {
        GLint result;
