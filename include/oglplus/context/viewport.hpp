...
struct BoundsRange {
    ...
    /// The min limit
    GLint Min() const noexcept {
        return _v[0];
    }

    /// The max limit
    GLint Max() const noexcept {
        return _v[1];
    }
};
...
public:
     ...
     *  @gldefref{VIEWPORT}
     */
    static ViewportExtents Viewport() {
  ...
  GL_ARB_ES2_compatibility
     ...
     */
    static ViewportDepthRange DepthRange() {
