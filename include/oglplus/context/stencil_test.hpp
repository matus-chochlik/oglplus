...
struct StencilFuncArgs {
    ...
    CompareFunction Func() const noexcept {
    ...
    GLuint ValueMask() const noexcept {
        return _mask;
    }
...
struct StencilOperations {
    ...
    StencilOperation StencilFail() const noexcept {
        return _sfail;
    }

    StencilOperation DepthFail() const noexcept {
        return _dfail;
    }

    StencilOperation DepthPass() const noexcept {
        return _dpass;
    }
