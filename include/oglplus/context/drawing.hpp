...
public:
    ...
    static void DrawArrays(
      PrimitiveType primitive, GLint first, SizeType count) {
        OGLPLUS_GLFUNC(DrawArrays)(GLenum(primitive), first, count);
        OGLPLUS_VERIFY(DrawArrays, Error, EnumParam(primitive));
    }
    ...
    static void DrawArraysInstancedBaseInstance(
      ...
      SizeType base_instance) {
        ...
        (GLenum(primitive), first, count, inst_count, base_instance);
        OGLPLUS_VERIFY(
          DrawArraysInstancedBaseInstance, Error, EnumParam(primitive));
    }
#endif
    ...
    static void DrawArraysInstanced(
      ...
      SizeType inst_count) {
        ...
        (GLenum(primitive), first, count, inst_count);
        OGLPLUS_VERIFY(DrawArraysInstanced, Error, EnumParam(primitive));
    }
#endif
    ...
    static void DrawArraysIndirect(
      PrimitiveType primitive, const void* indirect = nullptr) {
        OGLPLUS_GLFUNC(DrawArraysIndirect)(GLenum(primitive), indirect);
        OGLPLUS_VERIFY(DrawArraysIndirect, Error, EnumParam(primitive));
    }
#endif
    ...
    static void MultiDrawArrays(
      ...
      SizeType primcount) {
        ...
        (GLenum(primitive),
         ...
         primcount);
        OGLPLUS_VERIFY(MultiDrawArrays, Error, EnumParam(primitive));
    }
#endif
    ...
    static void MultiDrawArraysIndirect(
      ...
      const void* indirect = nullptr) {
        ...
        (GLenum(primitive), indirect, draw_count, stride);
        OGLPLUS_VERIFY(MultiDrawArraysIndirect, Error, EnumParam(primitive));
    }
#endif
    ...
    static void DrawElements(
      PrimitiveType primitive, SizeType count, DataType data_type) {
        OGLPLUS_GLFUNC(DrawElements)
        (GLenum(primitive), count, GLenum(data_type), nullptr);
        OGLPLUS_VERIFY(DrawElements, Error, EnumParam(primitive));
    }
    ...
    DrawElements(PrimitiveType primitive, SizeType count, const T* indices) {
        OGLPLUS_GLFUNC(DrawElements)
        (GLenum(primitive), count, GLenum(GetDataType<T>()), indices);
        OGLPLUS_VERIFY(DrawElements, Error, EnumParam(primitive));
    }
    ...
    static void DrawElementsInstanced(
      ...
      SizeType instance_count) {
        ...
        (GLenum(primitive), count, GLenum(data_type), nullptr, instance_count);
        OGLPLUS_VERIFY(DrawElementsInstanced, Error, EnumParam(primitive));
    }
    ...
    static void DrawElementsInstancedBaseInstance(
      ...
      GLuint base_instance) {
        ...
        (GLenum(primitive),
         ...
         base_instance);
        OGLPLUS_VERIFY(
          DrawElementsInstancedBaseInstance, Error, EnumParam(primitive));
    }
    ...
    static void MultiDrawElements(
      ...
      SizeType draw_count) {
        ...
        (GLenum(primitive),
         ...
         nullptr,
         draw_count);
        OGLPLUS_VERIFY(MultiDrawElements, Error, EnumParam(primitive));
    }
    ...
    static void DrawRangeElements(
      ...
      DataType data_type) {
        ...
        (GLenum(primitive), start, end, count, GLenum(data_type), nullptr);
        OGLPLUS_VERIFY(DrawRangeElements, Error, EnumParam(primitive));
    }
    ...
    static void DrawElementsIndirect(
      ...
      const void* indirect = nullptr) {
        ...
        (GLenum(primitive), GLenum(data_type), indirect);
        OGLPLUS_VERIFY(DrawElementsIndirect, Error, EnumParam(primitive));
    }
#endif
    ...
    static void MultiDrawElementsIndirect(
      ...
      const void* indirect = nullptr) {
        ...
        (GLenum(primitive), GLenum(data_type), indirect, draw_count, stride);
        OGLPLUS_VERIFY(MultiDrawElementsIndirect, Error, EnumParam(primitive));
    }
#endif
  ...
  GL_ARB_draw_elements_base_vertex
    ...
    static void DrawElementsBaseVertex(
      ...
      GLint base_vertex) {
        ...
        (GLenum(primitive), count, GLenum(data_type), nullptr, base_vertex);
        OGLPLUS_VERIFY(DrawElementsBaseVertex, Error, EnumParam(primitive));
    }
    /// Draws a sequence of primitives from the bound element array buffers
    ...
    static void DrawRangeElementsBaseVertex(
      ...
      GLint base_vertex) {
        ...
        (GLenum(primitive),
         ...
         base_vertex);
        OGLPLUS_VERIFY(
          DrawRangeElementsBaseVertex, Error, EnumParam(primitive));
    }
    ...
    static void DrawElementsInstancedBaseVertex(
      ...
      GLint base_vertex) {
        ...
        (GLenum(primitive),
         ...
         base_vertex);
        OGLPLUS_VERIFY(
          DrawElementsInstancedBaseVertex, Error, EnumParam(primitive));
    }
    ...
    static void MultiDrawElementsBaseVertex(
      ...
      const GLint* base_vertex) {
        ...
        OGLPLUS_VERIFY(
          MultiDrawElementsBaseVertex, Error, EnumParam(primitive));
    }
    ...
    static void DrawTransformFeedback(
      PrimitiveType primitive, TransformFeedbackName xfb) {
        OGLPLUS_GLFUNC(DrawTransformFeedback)
        (GLenum(primitive), GetGLName(xfb));
        OGLPLUS_VERIFY(
          DrawTransformFeedback, ObjectError, Object(xfb).EnumParam(primitive));
    }
#endif
    ...
    static void DrawTexture(
      ...
      GLfloat t1) {
        ...
        (GetGLName(texture),
         ...
         t1);
        OGLPLUS_CHECK(
          DrawTextureNV, ObjectPairError, Subject(sampler).Object(texture));
    }
    ...
    static void DrawTexture(
      ...
      GLfloat y1,
      GLfloat z) {
        DrawTexture(texture, SamplerName(), x0, y0, x1, y1, z, 0, 0, 1, 1);
    }
#endif
};
...
public:
    ...
    static void PrimitiveRestartIndex(GLuint index) {
        ...
        OGLPLUS_CHECK(PrimitiveRestartIndex, Error, Index(index));
    }

    static GLuint PrimitiveRestartIndex() {
        GLint result;
        OGLPLUS_GLFUNC(GetIntegerv)(GL_PRIMITIVE_RESTART_INDEX, &result);
    ...
    static void PatchParameter(oglplus::PatchParameter parameter, GLint value) {
        OGLPLUS_GLFUNC(PatchParameteri)(GLenum(parameter), value);
        OGLPLUS_CHECK(PatchParameteri, Error, EnumParam(parameter));
    }
#endif
};
