...
class CellImageGen : public Image {
private:
...
public:
    struct EulerDistance {
        double operator()(
          ...
          const Vector<double, 3>& is) const {
            double result = 0.0;
        ...
        for(GLsizei z = 0; z < Depth(); ++z) {
            ...
            for(GLsizei y = 0; y < Height(); ++y) {
                ...
                for(GLsizei x = 0; x < Width(); ++x) {
                    ...
                    Vector<double, 3> tc =
                      Vector<double, 3>(x * i_w, y * i_h, z * i_d);
...
class WorleyCellGen : public CellImageGen<GLubyte, 1> {
private:
    using Base = CellImageGen<GLubyte, 1>;
    ...
    struct DistanceValue {
        ...
        Vector<double, 1> operator()(
          const double* dists, const Vector<double, 3>*, SizeType count) {
