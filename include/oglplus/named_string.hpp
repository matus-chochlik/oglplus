...
public:
    ...
    static void Set(
      NamedStringType type, const StrCRef& str_name, const StrCRef& value) {
    ...
    static String Get(const StrCRef& str_name) {
        ...
        (GLint(str_name.size()), str_name.c_str(), len, &len, &result.front());
    ...
    static void Delete(const StrCRef& str_name) {
        ...
        (GLint(str_name.size()), str_name.c_str());
    ...
    NamedString(NamedStringType type, String&& str_name, const StrCRef& value)
