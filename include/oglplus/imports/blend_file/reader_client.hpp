...
protected:
    static void _adjust_ptr_size(
      BlendFileReader& reader, std::size_t ptr_size) {
    ...
    static std::array<char, size> _read_array(
      BlendFileReader& reader, const char* error_message) {
    ...
    static char _read_char(BlendFileReader& reader, const char* error_message) {
