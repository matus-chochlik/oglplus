...
struct BlendFileVisitor {
    ...
    virtual void VisitFlt(float v) {
        VisitDbl(v);
    }

    virtual void VisitU64(uint64_t) = 0;
    virtual void VisitU32(uint32_t v) {
        VisitU64(v);
    }
    virtual void VisitU16(uint16_t v) {
        VisitU64(v);
    }
    virtual void VisitU8(uint8_t v) {
        VisitU64(v);
    }

    virtual void VisitI64(int64_t) = 0;
    virtual void VisitI32(int32_t v) {
        VisitI64(v);
    }
    virtual void VisitI16(int16_t v) {
        VisitI64(v);
    }
    virtual void VisitI8(int8_t v) {
        VisitI64(v);
    }
