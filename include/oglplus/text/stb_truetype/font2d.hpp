...
#ifndef OGLPLUS_TEXT_STB_TRUETYPE_1102101236_HPP
#define OGLPLUS_TEXT_STB_TRUETYPE_1102101236_HPP
...
private:
    ...
    STBTTFont2DGlyph(const ::stbtt_fontinfo& font, CodePoint code_point)
      : _font(&font) {
...
public:
    ...
    void GetBitmapBox(
      float xscale, float yscale, int& x0, int& y0, int& x1, int& y1) const {
        ::stbtt_GetGlyphBitmapBox(
          _font, _index, xscale, yscale, &x0, &y0, &x1, &y1);
    }
    ...
    void GetBitmapBoxSubpixel(
      ...
      int& y1) const {
        ::stbtt_GetGlyphBitmapBoxSubpixel(
          _font, _index, xscale, yscale, xoffs, yoffs, &x0, &y0, &x1, &y1);
    }
...
public:
    ...
    static int KernAdvance(const Glyph& glyph1, const Glyph& glyph2) {
        ...
        return ::stbtt_GetGlyphKernAdvance(
          glyph1._font, glyph1._index, glyph2._index);
    }
    ...
    Layout MakeLayout(
      const CodePoint* code_points, const std::size_t cp_n) const;
