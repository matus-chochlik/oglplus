...
private:
	struct _intf {
		...
		virtual GLfloat QueryXOffsets(const CodePoint* cps,
		  GLsizei size,
	...
	public:
		...
		const void* _addr(void) override {
		...
		GLfloat QueryXOffsets(const CodePoint* cps,
		  GLsizei size,
...
private:
	...
	public:
		...
		GLsizei Capacity(void) const override {
			return _layout.Capacity();
		}

		GLfloat Width(void) const override {
