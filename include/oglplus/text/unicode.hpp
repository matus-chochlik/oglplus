 ...
 *  @ingroup text_rendering
 */
void UTF8ToCodePoints(const char* begin, const char* end, CodePoints& result);
...
void UTF8ToCodePoints(
  const char* c_str, std::size_t length, CodePoints& result);

inline CodePoints UTF8ToCodePoints(const char* begin, const char* end) {
    CodePoints result;
    UTF8ToCodePoints(begin, end, result);
    return result;
}

inline CodePoints UTF8ToCodePoints(const char* c_str, std::size_t length) {
    CodePoints result;
...
void CodePointsToUTF8(
  const CodePoint* begin, const CodePoint* end, std::vector<char>& result);
 ...
 */
void CodePointsToUTF8(
  const CodePoint* c_str, std::size_t length, std::vector<char>& result);

inline std::vector<char> CodePointsToUTF8(
  const CodePoint* begin, const CodePoint* end) {
...
inline std::vector<char> CodePointsToUTF8(
  const CodePoint* c_str, std::size_t length) {
    std::vector<char> result;
