...
class DefaultRendererTpl : public ConcreteRenderer {
private:
    ProgramUniform<Mat4f> _projection_matrix, _camera_matrix, _layout_matrix;
...
public:
    ...
    DefaultRendererTpl(
      ConcreteRenderingImpl& parent, const Sequence<ShaderName>& shaders)
