...
public:
    ...
    static void BindLocation(
      ProgramName program, VertexAttribSlot location, StrCRef identifier) {
    ...
    static VertexAttribSlot GetLocation(
      ProgramName program, StrCRef identifier) {
    ...
    static bool QueryActiveLocation(
      ProgramName program, StrCRef identifier, VertexAttribSlot& location) {
...
protected:
    ...
    template <typename T>
    static GLint _get_vpv(TypeTag<T>) {
        return 1;
    }

    template <typename T, std::size_t N>
    static GLint _get_vpv(TypeTag<Vector<T, N>>) {
        return N;
    }

    template <typename T, std::size_t Rows, std::size_t Cols>
    static GLint _get_vpv(TypeTag<Matrix<T, Rows, Cols>>) {
        return Rows * Cols;
    }
...
public:
    ...
    void Divisor(GLuint divisor) const {
        OGLPLUS_GLFUNC(VertexAttribDivisor)(_attrib_index(), divisor);
...
OGLPLUS_DECLARE_PROG_VAR(
  VertexAttrib, tag::ImplicitSel, tag::VertexAttrib, tag::NoTypecheck)

/// Encapsulates vertex array attribute functionality
/**
 *  @ingroup shader_variables
 */
class VertexArrayAttrib : public ProgVarCommonOps<tag::VertexAttrib> {
private:
    GLuint _attrib_index() const {
        if(this->_location < 0) {
            return GL_INVALID_INDEX;
...
public:
    ...
    const VertexArrayAttrib& Setup(
      GLint values_per_vertex, DataType data_type) const {
        if(data_type == DataType::Float) {
            Pointer(values_per_vertex, data_type, false, 0, nullptr);
        }
#ifdef GL_DOUBLE
        else if(data_type == DataType::Double) {
            LPointer(values_per_vertex, data_type, 0, nullptr);
        }
#endif
        else {
            IPointer(values_per_vertex, data_type, 0, nullptr);
        }
        return *this;
    }
    ...
    const VertexArrayAttrib& Setup(
      ...
      std::integral_constant<DataType, DataType::Float>) const {
        return Pointer(values_per_vertex, DataType::Float, false, 0, nullptr);
    }

#ifdef GL_DOUBLE
    const VertexArrayAttrib& Setup(
      GLint values_per_vertex,
      std::integral_constant<DataType, DataType::Double>) const {
        return LPointer(values_per_vertex, DataType::Double, 0, nullptr);
    }
#endif
    ...
    const VertexArrayAttrib& Setup(
      GLint values_per_vertex,
      std::integral_constant<DataType, DataTypeValue>) const {
        return IPointer(values_per_vertex, DataTypeValue, 0, nullptr);
    }
    ...
    const VertexArrayAttrib& Pointer(
      ...
      const void* pointer) const {
        ...
        (_attrib_index(),
         ...
         pointer);
        OGLPLUS_CHECK(
          VertexAttribPointer, Error, EnumParam(data_type).Index(_location));
        return *this;
    }
    ...
    const VertexArrayAttrib& IPointer(
      ...
      const void* pointer) const {
        ...
        (_attrib_index(),
         ...
         pointer);
        OGLPLUS_CHECK(
          VertexAttribIPointer, Error, EnumParam(data_type).Index(_location));
        return *this;
    }
    ...
    const VertexArrayAttrib& LPointer(
      ...
      const void* pointer) const {
        ...
        (_attrib_index(),
         ...
         pointer);
        OGLPLUS_CHECK(
          VertexAttribLPointer, Error, EnumParam(data_type).Index(_location));
        return *this;
    }
#else
    const VertexArrayAttrib& LPointer(
      GLint, DataType, SizeType, const void*) const {
        assert(!
    ...
    const VertexArrayAttrib& Format(
      ...
      GLuint relative_offset) const {
        ...
        (_attrib_index(),
         ...
         relative_offset);
        OGLPLUS_CHECK(
          VertexAttribFormat, Error, EnumParam(data_type).Index(_location));
        return *this;
    }
    ...
    const VertexArrayAttrib& IFormat(
      ...
      GLuint relative_offset) const {
        ...
        (_attrib_index(),
         ...
         relative_offset);
        OGLPLUS_CHECK(
          VertexAttribIFormat, Error, EnumParam(data_type).Index(_location));
        return *this;
    }
    ...
    const VertexArrayAttrib& LFormat(
      ...
      GLuint relative_offset) const {
        ...
        (_attrib_index(),
         ...
         relative_offset);
        OGLPLUS_CHECK(
          VertexAttribLFormat, Error, EnumParam(data_type).Index(_location));
        return *this;
    }
#endif
     ...
     */
    const VertexArrayAttrib& Enable() const {
        OGLPLUS_GLFUNC(EnableVertexAttribArray)(_attrib_index());
        OGLPLUS_VERIFY(EnableVertexArrayAttrib, Error, Index(_location));
        return *this;
    }
     ...
     */
    const VertexArrayAttrib& Disable() const {
        OGLPLUS_GLFUNC(DisableVertexAttribArray)(_attrib_index());
        OGLPLUS_VERIFY(DisableVertexArrayAttrib, Error, Index(_location));
        return *this;
    }
};
...
inline VertexArrayAttrib operator|(
  ProgramName program, const GLchar (&identifier)[N]) {
 ...
 *  @see VertexArrayAttrib
 */
inline VertexArrayAttrib operator|(ProgramName program, GLuint location) {
