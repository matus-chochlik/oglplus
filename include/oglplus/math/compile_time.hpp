...
struct Binomial {
    ...
    static const unsigned value =
      (Factorial<N>::value) / (Factorial<N - K>::value * Factorial<K>::value);
};
...
public:
    template <unsigned D>
    static T B(
      std::integral_constant<unsigned, D> d, const T* v, size_t s, P t) {
        OGLPLUS_FAKE_USE(s);
        assert(s >= N);
...
private:
    template <unsigned I>
    static T _part(
      std::integral_constant<unsigned, I>, const T* v, const W* w, P t) {
    ...
    static T _sum(
      std::integral_constant<unsigned, 0> i, const T* v, const W* w, P t) {
        return _part(i, v, w, t);
    }

    template <unsigned I>
    static T _sum(
      std::integral_constant<unsigned, I> i, const T* v, const W* w, P t) {
        std::integral_constant<unsigned, I - 1> i_1;
