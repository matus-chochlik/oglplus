...
private:
    ...
    ShapeAnalyzerVert(
      const ShapeAnalyzerGraphData& data, GLuint face_index, GLuint vert_index)
      : _data(data)
...
public:
     ...
     *  for example.
     */
    Vector<double, 4> MainAttrib() const;
     ...
     *  something else.
     */
    Vector<double, 4> SmoothAttrib() const;
};
...
private:
    ...
    ShapeAnalyzerEdge(
      const ShapeAnalyzerGraphData& data, GLuint face_index, GLuint edge_index)
      : _data(data)
      , _face_index(face_index)
