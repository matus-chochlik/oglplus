...
private:
    ...
    static std::vector<GLuint> _adapt(const Index& index) {
        return std::vector<GLuint>(index.begin(), index.end());
    }
...
public:
    ...
    static const GLuint _flg_strip_edge =
      _flg_smooth_edge | _flg_contin_edge | 0x0004;
    static const GLuint _flg_fan_edge =
      _flg_smooth_edge | _flg_contin_edge | 0x0008;
