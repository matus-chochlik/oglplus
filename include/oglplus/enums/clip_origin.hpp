//  File include/oglplus/enums/clip_origin.hpp
//
...
/// Enumeration ClipOrigin
/**
 *  @ingroup oglplus_enumerations
 */
OGLPLUS_ENUM_CLASS_BEGIN(ClipOrigin, GLenum)
#include <oglplus/enums/clip_origin.ipp>
OGLPLUS_ENUM_CLASS_END(ClipOrigin)
