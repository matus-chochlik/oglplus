...
protected:
	...
	static Boolean IsA(GLuint name) {
		Boolean result(OGLPLUS_GLFUNC(IsPathNV)(name), std::nothrow);
...
public:
	...
	ObjectOps& Commands(SizeType num_commands,
	  ...
	  const CoordType* coords) {
		...
		OGLPLUS_CHECK(PathCommandsNV, ObjectError, Object(*this));
		return *this;
	}
	 ...
	 */
	template <typename CoordType>
	ObjectOps& Commands(const std::vector<PathNVCommand>& commands,
	...
	ObjectOps& Coords(SizeType num_coords, const CoordType* coords) {
		...
		(_obj_name(),
		  ...
		  GLenum(GetDataType<CoordType>()),
		  static_cast<const void*>(coords));
		OGLPLUS_CHECK(PathCoordsNV, ObjectError, Object(*this));
		return *this;
	}
	 ...
	 */
	template <typename CoordType>
	ObjectOps& SubCommands(SizeType command_start,
	  ...
	  const CoordType* coords) {
		...
		(_obj_name(),
		  ...
		  GLenum(GetDataType<CoordType>()),
		  static_cast<const void*>(coords));
		OGLPLUS_CHECK(PathSubCommandsNV, ObjectError, Object(*this));
		return *this;
	}
	 ...
	 */
	template <typename CoordType>
	ObjectOps& SubSpec(SizeType command_start,
	  SizeType commands_to_delete,
	...
	template <typename CoordType>
	ObjectOps& SubCoords(
	  SizeType coord_start, SizeType num_coords, const CoordType* coords) {
		...
		(_obj_name(),
		  ...
		  GLenum(GetDataType<CoordType>()),
		  static_cast<const void*>(coords));
		OGLPLUS_CHECK(PathSubCoordsNV, ObjectError, Object(*this));
		return *this;
	}
	...
	template <typename CoordType>
	ObjectOps& SubCoords(
	  SizeType coord_start, const std::vector<CoordType>& coords) {
		OGLPLUS_GLFUNC(PathSubCoordsNV)
		(_obj_name(),
		  coord_start,
		  GLsizei(coords.size()),
	...
	ObjectOps& PathString(
	  PathNVFormat format, SizeType length, const GLchar* path_string) {
		OGLPLUS_GLFUNC(PathStringNV)
		(_obj_name(),
		  GLenum(format),
		  length,
		  static_cast<const void*>(path_string));
		OGLPLUS_CHECK(PathStringNV, ObjectError, Object(*this));
		return *this;
	}
	...
	Boolean IsPointInFill(GLuint mask, GLfloat x, GLfloat y) const {
		Boolean result(
		  OGLPLUS_GLFUNC(IsPointInFillPathNV)(_obj_name(), mask, x, y),
		  std::nothrow);
		OGLPLUS_VERIFY(IsPointInFillPathNV, ObjectError, Object(*this));
		return result;
	}
	...
	Boolean IsPointInStroke(GLfloat x, GLfloat y) const {
		Boolean result(OGLPLUS_GLFUNC(IsPointInStrokePathNV)(_obj_name(), x, y),
		  std::nothrow);
		OGLPLUS_VERIFY(IsPointInStrokePathNV, ObjectError, Object(*this));
		return result;
	}
	...
	GLfloat GetLength(SizeType start_segment, SizeType num_segments) const {
		GLfloat result = OGLPLUS_GLFUNC(GetPathLengthNV)(
		  _obj_name(), start_segment, num_segments);
		OGLPLUS_CHECK(GetPathLengthNV, ObjectError, Object(*this));
		return result;
	}
	 ...
	 */
	Boolean PointAlong(SizeType start_segment,
	  SizeType num_segments,
	  GLfloat distance,
	  GLfloat& ref_x,
	  GLfloat& ref_y,
	  GLfloat& ref_tg_x,
	  GLfloat& ref_tg_y) const {
		Boolean result(OGLPLUS_GLFUNC(PointAlongPathNV)(_obj_name(),
						 start_segment,
						 num_segments,
						 distance,
						 &ref_x,
						 ...
						 &ref_tg_y),
		  std::nothrow);
		OGLPLUS_CHECK(PointAlongPathNV, ObjectError, Object(*this));
		return result;
	}
	...
	ObjectOps& StrokeWidth(GLfloat width) {
		...
		(_obj_name(), GL_PATH_STROKE_WIDTH_NV, width);
		OGLPLUS_CHECK(PathParameterfNV, ObjectError, Object(*this));
		return *this;
	}
	...
	GLfloat StrokeWidth(void) {
		...
		OGLPLUS_VERIFY(GetPathParameterfvNV, ObjectError, Object(*this));
		return result;
	}
	...
	ObjectOps& MiterLimit(GLfloat width) {
		OGLPLUS_GLFUNC(PathParameterfNV)
		(_obj_name(), GL_PATH_MITER_LIMIT_NV, width);
		OGLPLUS_CHECK(PathParameterfNV, ObjectError, Object(*this));
		return *this;
	}
	...
	ObjectOps& JoinStyle(PathNVJoinStyle style) {
		OGLPLUS_GLFUNC(PathParameterfNV)
		(_obj_name(), GL_PATH_JOIN_STYLE_NV, GLenum(style));
		OGLPLUS_CHECK(PathParameterfNV, ObjectError, Object(*this));
		return *this;
	}
	...
	ObjectOps& InitialEndCap(PathNVCapStyle style) {
		OGLPLUS_GLFUNC(PathParameterfNV)
		(_obj_name(), GL_PATH_INITIAL_END_CAP_NV, GLenum(style));
		OGLPLUS_CHECK(PathParameterfNV, ObjectError, Object(*this));
		return *this;
	}
	...
	ObjectOps& TerminalEndCap(PathNVCapStyle style) {
		OGLPLUS_GLFUNC(PathParameterfNV)
		(_obj_name(), GL_PATH_TERMINAL_END_CAP_NV, GLenum(style));
		OGLPLUS_CHECK(PathParameterfNV, ObjectError, Object(*this));
		return *this;
	}
	...
	ObjectOps& InitialDashCap(PathNVCapStyle style) {
		OGLPLUS_GLFUNC(PathParameterfNV)
		(_obj_name(), GL_PATH_INITIAL_DASH_CAP_NV, GLenum(style));
		OGLPLUS_CHECK(PathParameterfNV, ObjectError, Object(*this));
		return *this;
	}
	...
	ObjectOps& TerminalDashCap(PathNVCapStyle style) {
		OGLPLUS_GLFUNC(PathParameterfNV)
		(_obj_name(), GL_PATH_TERMINAL_DASH_CAP_NV, GLenum(style));
		OGLPLUS_CHECK(PathParameterfNV, ObjectError, Object(*this));
		return *this;
	}
	...
	ObjectOps& DashOffset(GLfloat width) {
		OGLPLUS_GLFUNC(PathParameterfNV)
		(_obj_name(), GL_PATH_DASH_OFFSET_NV, width);
		OGLPLUS_CHECK(PathParameterfNV, ObjectError, Object(*this));
		return *this;
	}
	...
	ObjectOps& DashOffsetReset(PathNVDashOffsetReset mode) {
		OGLPLUS_GLFUNC(PathParameterfNV)
		(_obj_name(), GL_PATH_DASH_OFFSET_RESET_NV, GLenum(mode));
		OGLPLUS_CHECK(PathParameterfNV, ObjectError, Object(*this));
		return *this;
	}
	...
	ObjectOps& DashArray(SizeType dash_count, const GLfloat* dash_array) {
		OGLPLUS_GLFUNC(PathDashArrayNV)(_obj_name(), dash_count, dash_array);
		OGLPLUS_CHECK(PathDashArrayNV, ObjectError, Object(*this));
		return *this;
	}
	...
	ObjectOps& ClientLength(GLfloat value) {
		OGLPLUS_GLFUNC(PathParameterfNV)
		(_obj_name(), GL_PATH_CLIENT_LENGTH_NV, value);
		OGLPLUS_CHECK(PathParameterfNV, ObjectError, Object(*this));
		return *this;
	}
	...
	ObjectOps& StencilFill(PathNVFillMode mode, GLuint mask) {
		OGLPLUS_GLFUNC(StencilFillPathNV)(_obj_name(), GLenum(mode), mask);
		OGLPLUS_CHECK(StencilFillPathNV, ObjectError, Object(*this));
		return *this;
	}
	...
	ObjectOps& CoverFill(PathNVFillCoverMode mode) {
		...
		OGLPLUS_CHECK(CoverFillPathNV, ObjectError, Object(*this));
		return *this;
	}
	...
	ObjectOps& StencilStroke(GLint reference, GLuint mask) {
		OGLPLUS_GLFUNC(StencilStrokePathNV)(_obj_name(), reference, mask);
		OGLPLUS_CHECK(StencilStrokePathNV, ObjectError, Object(*this));
		return *this;
	}
	...
	ObjectOps& CoverStroke(PathNVStrokeCoverMode mode) {
		...
		OGLPLUS_CHECK(CoverStrokePathNV, ObjectError, Object(*this));
		return *this;
	}
	...
	static PathNVName Copy(PathNVName dest_path, PathNVName src_path) {
		OGLPLUS_GLFUNC(CopyPathNV)(GetGLName(dest_path), GetGLName(src_path));
		OGLPLUS_CHECK(
		  CopyPathNV, ObjectPairError, Subject(src_path).Object(dest_path));
		return dest_path;
	}
	 ...
	 */
	static PathNVName Interpolate(PathNVName dest_path,
	  PathNVName path_a,
	  PathNVName path_b,
	  GLfloat weight) {
		OGLPLUS_GLFUNC(InterpolatePathsNV)
		(GetGLName(dest_path), GetGLName(path_a), GetGLName(path_b), weight);
		OGLPLUS_CHECK(InterpolatePathsNV, ObjectError, Object(dest_path));
		return dest_path;
	}
	 ...
	 */
	static PathNVName Transform(PathNVName dest_path,
	  PathNVName src_path,
	  ...
	  const GLfloat* transform_values) {
		...
		(GetGLName(dest_path),
		  ...
		  transform_values);
		OGLPLUS_CHECK(TransformPathNV,
		  ObjectPairError,
		  Subject(src_path).Object(dest_path));
		return dest_path;
	}
};
