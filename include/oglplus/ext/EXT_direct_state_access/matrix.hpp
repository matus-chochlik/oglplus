...
public:
    ...
    DSAMatrixEXT& Load(const Matrix<GLfloat, 4, 4>& matrix) {
        OGLPLUS_GLFUNC(MatrixLoadTransposefEXT)(GLenum(_mode), Data(matrix));
    ...
    DSAMatrixEXT& Load(const Matrix<GLdouble, 4, 4>& matrix) {
        OGLPLUS_GLFUNC(MatrixLoadTransposedEXT)(GLenum(_mode), Data(matrix));
    ...
    DSAMatrixEXT& Mult(const Matrix<GLfloat, 4, 4>& matrix) {
        OGLPLUS_GLFUNC(MatrixMultTransposefEXT)(GLenum(_mode), Data(matrix));
    ...
    DSAMatrixEXT& Mult(const Matrix<GLdouble, 4, 4>& matrix) {
        OGLPLUS_GLFUNC(MatrixMultTransposedEXT)(GLenum(_mode), Data(matrix));
     ...
     */
    DSAMatrixEXT& Rotate(
      Angle<GLfloat> angle, const GLfloat x, const GLfloat y, const GLfloat z) {
        OGLPLUS_GLFUNC(MatrixRotatefEXT)
        (GLenum(_mode), Degrees(angle), x, y, z);
    ...
    DSAMatrixEXT& Rotate(Angle<GLfloat> angle, const Vector<GLfloat, 3>& axis) {
        OGLPLUS_GLFUNC(MatrixRotatefEXT)
        (GLenum(_mode), Degrees(angle), At(axis, 0), At(axis, 1), At(axis, 2));
        OGLPLUS_VERIFY_SIMPLE(MatrixRotatefEXT);
        return *this;
    }
     ...
     */
    DSAMatrixEXT& Rotate(
      Angle<GLdouble> angle, const Vector<GLdouble, 3>& axis) {
    ...
    DSAMatrixEXT& Scale(const Vector<GLfloat, 3>& amount) {
        ...
        (GLenum(_mode), At(amount, 0), At(amount, 1), At(amount, 2));
        OGLPLUS_VERIFY_SIMPLE(MatrixScalefEXT);
        return *this;
    }
    ...
    DSAMatrixEXT& Ortho(
      ...
      GLdouble far_depth) {
        ...
        (GLenum(_mode), left, right, bottom, top, near_depth, far_depth);
