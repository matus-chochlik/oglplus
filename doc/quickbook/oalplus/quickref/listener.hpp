...
struct ListenerOrientation {
    ListenerOrientation(const __Vec3f& at, const __Vec3f& up) noexcept;

    __Vec3f At() const noexcept;

    __Vec3f Up() const noexcept;
};
...
public:
    ...
    static __ListenerOrientation Orientation(); /*<
    Return the orientation vectors of the listener.
    See [alfunc GetListenerfv], [alconst ORIENTATION].
    >*/
    static Vec3f OrientationAt();
    static Vec3f OrientationUp();
