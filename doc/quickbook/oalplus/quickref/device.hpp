...
public:
    CaptureDevice(
      ...
      __DataFormat format,
      ALCsizei bufsize); /*<
                      Constructs an object referencing the default audio capture
                      device. See [alcfunc CaptureOpenDevice].
                      >*/
    ...
    CaptureDevice(
      ...
      __DataFormat format,
      ALCsizei bufsize); /*<
                      Constructs an object referencing the specified audio
                      capture device. See [alcfunc CaptureOpenDevice].
                      >*/
};
