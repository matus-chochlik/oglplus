...
private:
    ...
    public:
        __Boolean IsEnabled() const /*<
        Checks if the capability is currently enabled ([^true])
        or disabled ([^false]).
        >*/
          noexcept;

        explicit operator __Boolean() const /*<
                Checks if the capability is currently enabled ([^true])
                or disabled ([^false]).
                >*/
          noexcept;
    ...
    public:
        __Boolean IsEnabled() const noexcept;

        explicit operator __Boolean() const noexcept;
...
public:
    __enums_EnumToClass_Capability<__Nothing, __Capability, CurrentCapability>
      Caps; /*<
