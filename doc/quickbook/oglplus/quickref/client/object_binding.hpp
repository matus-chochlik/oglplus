...
>*/
    ...
    public:
        ...
        Holder Push(
          __BufferName obj, __BufferSize offset, __BufferSize size); /*<
...
>*/
    ...
    public:
        ...
        __ObjectName<__ObjTag> Get() const noexcept;
...
>*/
    ...
    >*/
      : public __SettingStack<GLuint, ...> {
        ...
        __TextureName Get() const noexcept;
...
>*/
    ...
    public:
        ...
        __SamplerName Get() const noexcept;
