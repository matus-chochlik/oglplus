...
SamplerOpsAndSlot operator|(SamplerOps& sam, GLuint slot);

SamplerOps& operator<<(SamplerOps& sam, __TextureUnitSelector tus); /*< Bind >*/

SamplerOps& operator<<(SamplerOps& sam, __TextureFilter filter); /*< Filter >*/

SamplerOps& operator<<(
  SamplerOps& sam, __TextureMinFilter filter); /*< MinFilter >*/

SamplerOps& operator<<(
  SamplerOps& sam, __TextureMagFilter filter); /*< MagFilter >*/

SamplerOps& operator<<(
  SamplerOps& sam, __TextureCompareMode mode); /*< CompareMode >*/

SamplerOps& operator<<(
  SamplerOps& sam, __CompareFunction func); /*< CompareFunc >*/
{
...
SamplerOps& operator<<(
  SamplerOps& sam, __TextureWrap wrap); /*< Wrap mode on all coordinates >*/

SamplerOps& operator<<(
  SamplerOpsAndSlot sas,
  __TextureWrap wrap); /*< Wrap mode on the i-th coordinate >*/

template <typename T>
SamplerOps& operator<<(
  SamplerOps& sam, const Vector<T, 4>& col); /*< Border color >*/
