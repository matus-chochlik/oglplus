...
template <typename ObjTag>
__Group<__ObjectName<__ObjTag>> operator,(
  __ObjectName<__ObjTag> a, __ObjectName<__ObjTag> b); /*<
This operator creates a [^Group] containing two object names.
>*/

template <typename ObjTag>
__Group<__ObjectName<__ObjTag>>&& operator,(
  __Group<__ObjectName<__ObjTag>>&&, __ObjectName<__ObjTag>); /*<
...
template <typename... ObjTag>
__StaticGroup<__ObjectName<__ObjTag>, sizeof...(ObjTag)> MakeGroup(
  __ObjectName<__ObjTag>... names); /*<
Creates a static group from a pack of object names. All names must refer to
