...
public:
    ...
    static __ObjectName<__ObjTag> Binding(); /*<
...
template <typename __ObjTag>
class ObjCommonOps : public __ObjectName<__ObjTag> {
public: /*<
...
class ObjZeroOps : public __ObjCommonOps<__ObjTag> {
public: /*<
...
template <typename __OpsTag, typename __ObjTag>
class ObjectOps : public __ObjZeroOps<__OpsTag, __ObjTag> {
public: /*<
The public interface depends on the __OpsTag and __ObjTag.
>*/
};
