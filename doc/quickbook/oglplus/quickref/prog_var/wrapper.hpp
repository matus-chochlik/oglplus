...
public:
	...
	ProgVar(__ProgramName program, __CStrRef identifier); /*<
	...
	ProgVar(__ProgramName program, __CStrRef identifier, bool active_only); /*<
	Constructs a [^ProgVar] from a reference to a program
	and an identifier of the variable. If no such variable
	...
	ProgVar(__ProgramName program, __CStrRef identifier, std::nothrow_t); /*<
	Constructs a [^ProgVar] from a reference to a program
	...
	ProgVar& BindTo(__CStrRef identifier);
