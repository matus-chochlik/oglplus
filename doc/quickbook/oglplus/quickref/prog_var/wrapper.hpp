...
template <typename __VarTag>
class ProgVarCommonOps : public __ProgVarLoc<__VarTag> {
public:
};
...
class ProgVarGetSetOps : public __ProgVarCommonOps<__VarTag> {
public:
};
...
public:
    void CheckType(
      __ProgramName program, GLint location, __StrCRef identifier) const;
};
