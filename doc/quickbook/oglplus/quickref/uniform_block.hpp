...
public:
    static GLint GetLocation(
      ...
      bool active_only); /*<
                      ...
                      [^true] then throws __ProgVarError if no such uniform
                      block exists or if it is not active. See [glfunc
...
using Uniform = __ProgVar<
  ...
  __tag_NoTypecheck,
  void>; /*<
      [^UniformBlock] indirectly inherits from __ProgVarLocOps_UniformBlock and
      __ProgVarCommonOps_Uniform.
      >*/
