...
public:
    static GLint GetLocation(
      ...
      bool active_only); /*<
                      ...
                      [^true] then throws __ProgVarError if no such shader
                      storage block exists or if it is not active. See [glfunc
...
using ShaderStorage = __ProgVar<
  ...
  __tag_NoTypecheck,
  void>; /*<
      [^ShaderStorageBlock] indirectly inherits from
      __ProgVarLocOps_ShaderStorageBlock and __ProgVarCommonOps_ShaderStorage.
      >*/
