...
class ProgramBuildError : public __ObjectError {
public:
    ProgramBuildError(const char* message);

    const __String& Log() const; /*<
...
class CompileError : public __ProgramBuildError {
public:
...
class LinkError : public __ProgramBuildError {
public:
...
class ValidationError : public __ProgramBuildError {
public:
