...
public:
    ...
    >*/
    static void Bind(
      __FramebufferTarget target, __FramebufferName framebuffer); /*<
...
>*/
    ...
    static void AttachRenderbuffer(
      ...
      __RenderbufferName renderbuffer); /*<
                                     Attaches a [^renderbuffer] object as an
                                     [^attachment] to the framebuffer currently
                                     bound to the specified [^target]. See
                                     [glfunc FramebufferRenderbuffer].
                                     >*/
    static void AttachColorRenderbuffer(
      ...
      __RenderbufferName
        renderbuffer); /*<
                    Attaches a [^renderbuffer] object as a color attachment with
                    index specified by [^attachment_no] to the framebuffer
    ...
    static void AttachColorTexture(
      ...
      __TextureName texture,
      GLint level); /*<
                 Attaches the specified [^texture] [^level] as a color
                 attachment with index specified by [^attachment_no] to the
                 framebuffer currently bound to the specified [^target].
                 >*/
#endif
    ...
    static void Invalidate(
      __FramebufferTarget target,
      const __EnumArray<Property::Buffer>&
        buffers); /*<
               Invalidates the specified attachments or [^buffers] of the
               framebuffer currently bound to the specified [^target]. See
               [glfunc InvalidateFramebuffer].
               >*/
    static void Invalidate(
      __FramebufferTarget target,
      __SizeType count,
    ...
    static void Invalidate(
      ...
      __SizeType width,
      __SizeType height); /*<
                       Invalidates parts (specified by [^x], [^y], [^width] and
                       [^height]) of attachments or [^buffers] of the
                       framebuffer currently bound to the specified [^target].
...
__FramebufferTarget operator<<(
  ...
  __FramebufferTarget target); /*<
                            ...
                            >*/
FramebufferTarget operator<<(DefaultFramebuffer dfb, FramebufferTarget target);

#if GL_VERSION_3_2
__FramebufferTarget operator<<(
  FramebufferTargetAndAttch taa,
  __TextureName tex); /*<
                   Attaches [^tex] to the attachment of a framebuffer bound to a
                   target specified by [^taa].
                   >*/
#endif
...
__FramebufferTarget operator<<(
  ...
  __RenderbufferName rbo); /*<
                        Attaches [^rbo] to the attachment of a framebuffer bound
                        to a target specified by [^taa].
                        >*/
