...
>*/
    ...
    friend Vector<__T, Cols> operator*(
      const Vector& v, const __Matrix<__T, __N, Cols>& m); /*<
__Vector __times__  __Matrix multiplication.
>*/
    template <size_t Rows>
    friend Vector<__T, Rows> operator*(
      const __Matrix<__T, Rows, __N>& m, const Vector& v); /*<
