...
public:
    ImageHandle(
      ...
      __ImageUnitFormat format); /*<
                              Construction from a texture and additional
                              parameters. See [glfunc GetImageHandleARB].
                              >*/
