...
template <>
class __ObjCommonOps<__tag_ProgramPipeline> : public __ProgramPipelineName {
public:
    static __ProgramPipelineName Binding(); /*<
...
public:
    ...
    void UseStages(
      ...
      __ProgramName program) const; /*<
                           Uses the specified [^stages] of the specified
                           [^program]. See [glfunc UseProgramStages].
                           >*/
