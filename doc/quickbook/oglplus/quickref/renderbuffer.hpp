...
public:
    ...
    >*/
    static void Bind(
      __RenderbufferTarget target, __RenderbufferName renderbuffer); /*<
...
public:
    static void Storage(
      ...
      __SizeType
        height); /*<
              ...
              >*/
    static void Storage(
      __RenderbufferTarget target, const __images_ImageSpec& image_spec);
    ...
    static void StorageMultisample(
      ...
      __SizeType width,
      __SizeType height); /*<
                       Sets multipsample storage parameters for the renderbuffer
                       currently bound to the specified [^target]. See [glfunc
