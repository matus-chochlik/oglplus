...
>*/
    ...
    void GetImage(
      GLint level, __PixelDataFormat format, const __OutputData& dest)
      const; /*<
    ...
    void GetCompressedImage(GLint level, const __OutputData& dest)
      const; /*<
    Stores the image of [^this] texture with the specified [^level]
    ...
    ObjectOps& Image3D(
      const __images_Image& image, GLint level = 0, GLint border = 0);
    ...
    ObjectOps& SubImage2D(
      const __images_Image& image, GLint xoffs, GLint yoffs, GLint level = 0);
    ...
    ObjectOps& SubImage1D(
      const __images_Image& image, GLint xoffs, GLint level = 0);
    ...
    ObjectOps& CopySubImage3D(
      ...
      __SizeType height); /*<
                       ...
                       current framebuffer. See [glfunc CopyTextureSubImage3D].
                       >*/
    ...
    ObjectOps& CopySubImage2D(
      ...
      __SizeType height); /*<
                       ...
                       current framebuffer. See [glfunc CopyTextureSubImage2D].
                       >*/
    ...
    ObjectOps& CopySubImage1D(
      ...
      __SizeType width); /*<
                      ...
                      framebuffer. See [glfunc CopyTextureSubImage2D].
                      >*/
    ...
    See [glfunc TextureParameter], [glconst TEXTURE_MIN_FILTER], [glconst
    TEXTURE_MAG_FILTER].
    >*/
...
DSATextureOpsAndSlot operator|(DSATextureOps& tex, GLuint slot);

DSATextureOps& operator<<(
  DSATextureOps& tex, __TextureTarget target); /*< Bind >*/

DSATextureOps& operator<<(
  DSATextureOps& tex, __TextureFilter filter); /*< Filter >*/

DSATextureOps& operator<<(
  DSATextureOps& tex, __TextureMinFilter filter); /*< MinFilter >*/

DSATextureOps& operator<<(
  DSATextureOps& tex, __TextureMagFilter filter); /*< MagFilter >*/

DSATextureOps& operator<<(
  DSATextureOps& tex, __TextureCompareMode mode); /*< CompareMode >*/

DSATextureOps& operator<<(
  DSATextureOps& tex, __CompareFunction func); /*< CompareFunc >*/

DSATextureOps& operator<<(
  DSATextureOpsAndSlot tas, __TextureWrap wrap); /*< Wrap >*/

DSATextureOps& operator<<(
  DSATextureOps& tex, __TextureSwizzle swizzle); /*< Swizzle >*/

DSATextureOps& operator<<(
  DSATextureOpsAndSlot tas, __TextureSwizzle swizzle); /*< Swizzle >*/

template <typename T>
DSATextureOps& operator<<(
  DSATextureOps& tex, const Vector<T, 4>& col); /*< BorderColor >*/
