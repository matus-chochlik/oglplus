...
>*/
    ...
    void AttachRenderbuffer(
      ...
      __RenderbufferName renderbuffer); /*<
                                     ...
                                     [^attachment] to [^this] framebuffer. See
                                     [glfunc NamedFramebufferRenderbuffer].
                                     >*/
    ...
    void AttachColorTexture(
      ...
      GLint
        level); /*<
             Attaches the specified [^texture] [^level] as a color attachment
             with index specified by [^attachment_no] to [^this] framebuffer.
             >*/
