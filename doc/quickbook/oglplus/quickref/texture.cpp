...
>*/
                 ...
                 to be consumed, depending on the width, height, data type and
             other parameters. Optionally this pointer can be null, which causes
             a blank texture to be created.
             >*/
);
//]
