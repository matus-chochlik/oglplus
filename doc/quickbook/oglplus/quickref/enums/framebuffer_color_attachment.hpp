//  File doc/quickbook/oglplus/quickref/enums/framebuffer_color_attachment.hpp
//
...
template <>
__Range<FramebufferColorAttachment> __EnumValueName<FramebufferColorAttachment>(void);
#endif
