...
template <>
__Range<CompatibilityAttributeGroup>
__EnumValueRange<CompatibilityAttributeGroup>();

__StrCRef __EnumValueName(CompatibilityAttributeGroup);

__Bitfield<CompatibilityAttributeGroup> operator|(
  CompatibilityAttributeGroup b1, CompatibilityAttributeGroup b2);
