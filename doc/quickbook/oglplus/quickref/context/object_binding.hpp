...
public:
    ...
    static void Use(const Object& object); /*<
           Uses (makes current) the specified [^object] (for example a
           __Program). Equivalent to [^object.Use()].
           >*/

    template <typename __Object>
    static __Reference_ObjectOps_Bound<
      __ObjectOps_Bound<__tag_CurrentBound, __ObjTag>>
    Current(); /*<
