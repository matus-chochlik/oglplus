...
struct StencilFuncArgs {
    ...
    __CompareFunction Func() const noexcept;
...
struct StencilOperations {
    ...
    StencilOperations(
      ...
      __StencilOperation dpass) noexcept;

    __StencilOperation StencilFail() const noexcept;

    __StencilOperation DepthFail() const noexcept;

    __StencilOperation DepthPass() const noexcept;
...
public:
    static void StencilFunc(
      ...
      GLuint mask = ~GLuint(0)); /*<
                              Sets the stencil [^function], [^ref]erence value
                              and a [^mask]. See [glfunc StencilFunc].
                              >*/
    ...
    static void StencilFuncSeparate(
      ...
      GLuint mask =
        ~GLuint(0)); /*<
                  Sets the stencil [^function] separately for front and back
                  [^face]. See [glfunc StencilFuncSeparate].
                  >*/
    static void StencilFuncSeparate(
      __Face face, const __context_StencilFuncArgs& fa);
    static void StencilFuncSeparateSingle(
      ...
      GLuint mask = ~GLuint(0));
    static void StencilFuncSeparateSingle(
      __SingleFace face, const __context_StencilFuncArgs& fa);
    ...
    static void StencilOpSeparate(
      ...
      __StencilOperation dfail,
      __StencilOperation dpass); /*<
                              Sets the stencil operations separately for front
                              and back [^face]. See [glfunc StencilOpSeparate].
                              >*/
    ...
    See [glfunc Get], [glconst STENCIL_VALUE_MASK], [glconst
    ...
    See [glfunc Get], [glconst STENCIL_PASS_DEPTH_FAIL], [glconst
    ...
    Returns the stencil-pass depth-fail action.
    See [glfunc Get], [glconst STENCIL_PASS_DEPTH_PASS], [glconst
