...
public:
    ...
    static void PatchParameter(
      __PatchParameter parameter, GLint value); /*<
...
public:
    ...
    static void MultiDrawArrays(
      ...
      __SizeType primcount); /*<
                          Draws multiple primcount ranges of primitives from the
                          bound array buffers. See [glfunc MultiDrawArrays].
                          >*/
#endif
    ...
    template <typename T>
    static void DrawElements(
      __PrimitiveType primitive, __SizeType count, const T* indices);
