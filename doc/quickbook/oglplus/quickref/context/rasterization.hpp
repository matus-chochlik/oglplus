...
class PolygonModes {
public:
    PolygonModes() noexcept;

    PolygonModes(__PolygonMode mode) noexcept;

    PolygonModes(__PolygonMode front, __PolygonMode back) noexcept;

    PolygonMode Front() const noexcept;

    PolygonMode Back() const noexcept;
};

struct PolygonOffsPara {
    PolygonOffsPara() noexcept;

    PolygonOffsPara(GLfloat factor, GLfloat units) noexcept;

    GLfloat Factor() const noexcept;

    GLfloat Units() const noexcept;
};
...
public:
    ...
    >*/
    static __FaceOrientation FrontFace();

    static void CullFace(__Face mode); /*<
    Sets the face culling mode.
    See [glfunc CullFace].
    >*/
    static __Face CullFaceMode();
    ...
    static __PolygonMode PolygonModeFront(); /*<
    Returns the face culling mode.
    See [glfunc Get], [glconst POLYGON_MODE].
    >*/
    static __PolygonMode PolygonModeBack();
    static __context_PolygonModes PolygonMode();
#endif
...
//[oglplus_context_Rasterization2
    ...
    static __ProvokeMode ProvokingVertex(); /*<
