...
public:
    ...
    static GLfloat PixelStoreValue(
      ...
      __TypeTag<float>); /*<
                      ...
                      See [glfunc Get].
                      >*/
    static GLint PixelStoreValue(__PixelParameter parameter, __TypeTag<int>);
    static __Boolean PixelStoreValue(
      __PixelParameter parameter, __TypeTag<bool>);

    template <__PixelParameter Parameter>
    static __Unspecified PixelStoreValue(); /*<
    Gets the [^value] of a pixel storage [^Parameter].
...
public:
    ...
    static void BlitFramebuffer(
      ...
      __BlitFilter filter); /*<
                         Transfers a rectangle of pixels from the read buffer
                         the draw buffer. See [glfunc blitFramebuffer].
                         >*/
};
