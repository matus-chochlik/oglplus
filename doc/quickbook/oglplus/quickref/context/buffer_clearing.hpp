...
public:
    ...
    static __context_RGBAValue ColorClearValue(); /*<
    ...
    >*/
    static GLint ClearStencilValue(); /*<
   Returns the value used for clearing of the depth buffer.
...
public:
    ...
    static void ClearColorBuffer(
      __ColorBuffer buffer, GLint draw_buffer, const GLint* value); /*<
Clears the specified color draw buffer of the currently bound framebuffer
with the specified [^value].
>*/
    static void ClearColorBuffer(
      __ColorBuffer buffer, GLint draw_buffer, const GLuint* value);
    static void ClearColorBuffer(
      __ColorBuffer buffer, GLint draw_buffer, const GLfloat* value);
    ...
    static void ClearStencilBuffer(
      GLfloat depth_value, GLint stencil_value); /*<
