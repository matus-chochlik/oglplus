...
public:
    static void BindLocation(
      ...
      __StrCRef identifier); /*<
                          Binds the fragment data specified by [^identifier] to
                          the [^location] in the specified [^program]. See
                          [glfunc BindFragDataLocation].
                          >*/
    ...
    static GLint GetLocation(
      ...
      bool active_only); /*<
                      ...
                      [^true] then throws __ProgVarError if no such frag_data
                      exists or if it is not active. See [glfunc
                      GetFragDataLocation].
                      >*/
};
...
template <>
class __ProgVarCommonOps<__tag_FragData> : public __ProgVarLoc<__tag_FragData> {
public:
