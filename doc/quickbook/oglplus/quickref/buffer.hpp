...
public:
    ...
    static void BindBase(
      ...
      GLuint index,
      __BufferName buffer); /*<
                         Binds the specified [^buffer] to the specified
                         [^index]ed [^target].
                         >*/
    ...
    static void BindBase(
      ...
      const __Sequence<__BufferName>& buffers); /*<
                                             Sequentially binds all [^buffers]
                                             to indexed [^target]s starting at
                                             [^first] index.
                                             >*/
    ...
    static void BindRange(
      ...
      const GLsizeiptr*
        sizes); /*<
             Sequentially binds ranges (specified by [^offsets] and [^sizes]
             which must point to arrays of at least as much values as the
             [^buffers] sequence) of all [^buffers] to indexed [^target]s
    ...
    void BindBaseTransformFeedback(
      __TransformFeedbackBufferBindingPoint index) const /*<
...
>*/
      ...
      void BindBaseAtomicCounter(
        __AtomicCounterBufferBindingPoint index) const; /*<
...
>*/
    ...
    void BindBaseShaderStorage(
      __ShaderStorageBufferBindingPoint index) const; /*<
...
>*/
    ...
    void BindRange(
      ...
      GLuint index,
      __BufferSize offset,
      __BufferSize size) const; /*<
                       Binds a range (specified by [^offset] and [^size]) of
                       [^this] buffer to the specified [^index]ed [^target].
                       >*/
//]
...
public:
    ...
    static void Resize(
      ...
      __BufferUsage usage =
        BufferUsage::StaticDraw); /*<
                               Allocates or reallocates storage of a buffer
                               currently bound to [^target] to the specified
                               [^size] without uploading any data, taking
                               [^usage] as a hint. See [glfunc BufferData].
                               >*/
    ...
    static void RawData(
      ...
      __BufferUsage usage =
        BufferUsage::StaticDraw); /*<
                               Uploads [^size] bytes from the location pointed
                               to by [^data] to the buffer bound to the
                               specified [^target], taking [^usage] as a hint.
    ...
    static void Data(
      ...
      __BufferUsage usage =
        BufferUsage::StaticDraw); /*<
                               Uploads the specified [^data] to the buffer bound
                               to the specified
    ...
    static void SubData(
      ...
      __BufferSize offset,
      const __BufferData&
        data); /*< Uploads the specified [^data] to a sub-range (starting at
    ...
    static void CopySubData(
      ...
      __BufferSize size); /*<
                       Copies a block of data of the specified [^size] from a
                       buffer bound to [^readtarget] starting at [^readoffset]
                       to a buffer bound to [^writetarget] starting at
                       [^writeoffset]. See [glfunc CopyBufferSubData].
                       >*/
#endif
    ...
    static void ClearData(
      ...
      const GLtype* value); /*<
                         Clears the whole buffer bound to [^target] with the
                         specified fixed [^value], in the specified [^format].
    ...
    static void ClearSubData(
      ...
      __PixelDataFormat format,
      const GLtype*
        value); /*< Clears a sub-range (specified by [^offset] and [^size])
    ...
    static __Bitfield<__BufferStorageBit> StorageFlags(
      __BufferTarget target); /*<
...
>*/
    ...
    static void PageCommitment(
      ...
      __BufferSize size,
      __Boolean commit); /*<
                      Commits and de-commits regions (specified by [^offset] and
                      [^size]) of sparse buffer currently bound to the specified
                      [^target]. See [glfunc BufferPageCommitmentARB].
                      >*/

    static __SizeType PageSize(); /*<
...
__BufferTarget operator<<(
  const BufferOps& buf, __BufferTarget target); /*<
