...
//------------------------------------------------------------------------------
static void eglplus_egl_create_key_TLData() {
    ::pthread_key_create(&eglplus_egl_key_TLData, &eglplus_egl_destroy_TLData);
}
//------------------------------------------------------------------------------
static eglplus_egl_TLData& eglplus_egl_TLDataRef() {
    ::pthread_once(&eglplus_egl_once_TLData, &eglplus_egl_create_key_TLData);
    void* tlptr = ::pthread_getspecific(eglplus_egl_key_TLData);
    if(tlptr == nullptr) {
        tlptr = new eglplus_egl_TLData();
        ::pthread_setspecific(eglplus_egl_key_TLData, tlptr);
    }
    assert(tlptr);
    return *static_cast<eglplus_egl_TLData*>(tlptr);
}
//------------------------------------------------------------------------------
static void eglplus_egl_release_TLData() {
    ::pthread_once(&eglplus_egl_once_TLData, &eglplus_egl_create_key_TLData);
    void* tlptr = ::pthread_getspecific(eglplus_egl_key_TLData);
    if(tlptr != nullptr) {
...
// ErrorCode
//------------------------------------------------------------------------------
EGLint& eglplus_egl_ErrorCodeRef() {
    return eglplus_egl_TLDataRef().error_code;
}
//------------------------------------------------------------------------------
// Current
//------------------------------------------------------------------------------
eglplus_egl_glx_Current& eglplus_egl_CurrentRef() {
